...
! other variables (needs to be consistent with reset list below)
  integer :: idiag_E11xy=0      ! DIAG_DOC: $\E_{11}$
  integer :: idiag_E12xy=0      ! DIAG_DOC: $\E_{12}$
  integer :: idiag_E13xy=0      ! DIAG_DOC: $\E_{13}$
  integer :: idiag_E21xy=0      ! DIAG_DOC: $\E_{21}$
  integer :: idiag_E22xy=0      ! DIAG_DOC: $\E_{22}$
  integer :: idiag_E23xy=0      ! DIAG_DOC: $\E_{23}$
  integer :: idiag_E31xy=0      ! DIAG_DOC: $\E_{31}$
  integer :: idiag_E32xy=0      ! DIAG_DOC: $\E_{32}$
  integer :: idiag_E33xy=0      ! DIAG_DOC: $\E_{33}$
  integer :: idiag_E41xy=0      ! DIAG_DOC: $\E_{41}$
  integer :: idiag_E42xy=0      ! DIAG_DOC: $\E_{42}$
  integer :: idiag_E43xy=0      ! DIAG_DOC: $\E_{43}$
  integer :: idiag_E51xy=0      ! DIAG_DOC: $\E_{51}$
  integer :: idiag_E52xy=0      ! DIAG_DOC: $\E_{52}$
  integer :: idiag_E53xy=0      ! DIAG_DOC: $\E_{53}$
  integer :: idiag_E61xy=0      ! DIAG_DOC: $\E_{61}$
  integer :: idiag_E62xy=0      ! DIAG_DOC: $\E_{62}$
  integer :: idiag_E63xy=0      ! DIAG_DOC: $\E_{63}$
  integer :: idiag_E71xy=0      ! DIAG_DOC: $\E_{71}$
  integer :: idiag_E72xy=0      ! DIAG_DOC: $\E_{72}$
  integer :: idiag_E73xy=0      ! DIAG_DOC: $\E_{73}$
