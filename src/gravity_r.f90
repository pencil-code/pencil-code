! $Id: gravity_r.f90,v 1.31 2007-09-08 17:35:47 wlyra Exp $
...
!
      if (lroot) call cvs_id("$Id: gravity_r.f90,v 1.31 2007-09-08 17:35:47 wlyra Exp $")
!
      lgrav =.true.
      lgravr=.true.
      lgravr_gas =.true.
...
!
            ...
            case ('light-matter')
              if (lroot) &
                   print*,'initialize_gravity: potential generated by an exponential barionic disk'
              lpade=.false.
