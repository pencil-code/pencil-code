...
!
        case ('Frad')
          if (slices%index >= 3) then
            ...
            slices%yz=abs(f(slices%ix,m1:m2    ,n1:n2,iFradx+slices%index))
            slices%xz=abs(f(l1:l2    ,slices%iy,n1:n2,iFradx+slices%index))
            slices%xy=abs(f(l1:l2    ,m1:m2    ,slices%iz,iFradx+slices%index))
            slices%xy2=abs(f(l1:l2    ,m1:m2    ,slices%iz2,iFradx+slices%index))
            slices%index = slices%index+1
