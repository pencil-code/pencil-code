...
!
  ...
  integer :: idiag_dW1rms=0       ! DIAG_DOC: $\left<{\dot{\Wv}^1}^2\right>^{1/2}$
  integer :: idiag_dW2rms=0       ! DIAG_DOC: $\left<{\dot{\Wv}^2}^2\right>^{1/2}$
  integer :: idiag_dW3rms=0       ! DIAG_DOC: $\left<{\dot{\Wv}^3}^2\right>^{1/2}$
  integer :: idiag_dW1max=0       ! DIAG_DOC: $\max(|\dot{\Wv^1}|)$
  integer :: idiag_dW2max=0       ! DIAG_DOC: $\max(|\dot{\Wv^2}|)$
  integer :: idiag_dW3max=0       ! DIAG_DOC: $\max(|\dot{\Wv^3}|)$
  integer :: idiag_W1ddotrms=0.  ! DIAG_DOC: $\left<{\ddot{\Wv}^1}^2\right>^{1/2}$
  integer :: idiag_W2ddotrms=0.  ! DIAG_DOC: $\left<{\ddot{\Wv}^2}^2\right>^{1/2}$
  integer :: idiag_W3ddotrms=0.  ! DIAG_DOC: $\left<{\ddot{\Wv}^3}^2\right>^{1/2}$
  ...
  integer :: idiag_divdotW1rms=0 ! DIAG_DOC: $\left<{\nab\dot{\Wv}^1}^2\right>^{1/2}$
  integer :: idiag_divdotW2rms=0 ! DIAG_DOC: $\left<{\nab\dot{\Wv}^2}^2\right>^{1/2}$
  integer :: idiag_divdotW3rms=0 ! DIAG_DOC: $\left<{\nab\dot{\Wv}^3}^2\right>^{1/2}$
  integer :: idiag_rhoW1rms=0   ! DIAG_DOC: $\left<{\rho_{\Wv}^1}^2\right>^{1/2}$
  integer :: idiag_rhoW2rms=0   ! DIAG_DOC: $\left<{\rho_{\Wv}^2}^2\right>^{1/2}$
  integer :: idiag_rhoW3rms=0   ! DIAG_DOC: $\left<{\rho_{\Wv}^3}^2\right>^{1/2}$
  integer :: idiag_divdotW1m=0   ! DIAG_DOC: $\left<\nab\dot\Wv^1\right>$
  integer :: idiag_divdotW2m=0   ! DIAG_DOC: $\left<\nab\dot\Wv^2\right>$
  integer :: idiag_divdotW3m=0   ! DIAG_DOC: $\left<\nab\dot\Wv^3\right>$
  integer :: idiag_rhoW1m=0     ! DIAG_DOC: $\left<\rho_e\Wv^1\right>$
  integer :: idiag_rhoW2m=0     ! DIAG_DOC: $\left<\rho_e\Wv^2\right>$
  integer :: idiag_rhoW3m=0     ! DIAG_DOC: $\left<\rho_e\Wv^3\right>$
  ...
  integer :: idiag_dW1xm=0       ! DIAG_DOC: $\left<\dot{W^1}_x\right>$
  integer :: idiag_dW1ym=0       ! DIAG_DOC: $\left<\dot{W^1}_y\right>$
  integer :: idiag_dW1zm=0       ! DIAG_DOC: $\left<\dot{W^1}_z\right>$
  integer :: idiag_dW2xm=0       ! DIAG_DOC: $\left<\dot{W^2}_x\right>$
  integer :: idiag_dW2ym=0       ! DIAG_DOC: $\left<\dot{W^2}_y\right>$
  integer :: idiag_dW2zm=0       ! DIAG_DOC: $\left<\dot{W^2}_z\right>$
  integer :: idiag_dW3xm=0       ! DIAG_DOC: $\left<\dot{W^3}_x\right>$
  integer :: idiag_dW3ym=0       ! DIAG_DOC: $\left<\dot{W^3}_y\right>$
  integer :: idiag_dW3zm=0       ! DIAG_DOC: $\left<\dot{W^3}_z\right>$
  integer :: idiag_W1dotW1m=0     ! DIAG_DOC: $\left<\dot{\Wv}^1\cdot\Wv^1\right>$
  integer :: idiag_W2dotW2m=0     ! DIAG_DOC: $\left<\dot{\Wv}^2\cdot\Wv^2\right>$
  integer :: idiag_W3dotW3m=0     ! DIAG_DOC: $\left<\dot{\Wv}^3\cdot\Wv^3\right>$
!
