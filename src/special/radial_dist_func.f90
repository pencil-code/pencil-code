! $Id$
!
!  Calculate the radial distribution function based on a pre-generated
!  input file. This input file is generated by first reading the stored
!  data into IDL by the routine:
!    f90/pencil-christer/isoth_expwave/idl/pvar.pro
!  then the input file is generated with an adapted version of the
!  following routine:
!    f90/pencil-christer/isoth_expwave/idl/rnp256.pro
!  Finally you can then run start.csh with something like the following
!  start.in file:
!
!&init_pars
!  cvsid='$Id: start.in,v 1.1 2021/09/21 07:49:35 nilshau Exp $'
!  lseed_global=F
!  lwrite_ic=F
!  tstart=0.
!/
!&special_init_pars
! file_in='../np_ap1_4.dat'
!  rdf_stride_outer=4  !(1:14 min)
!  rdf_stride_outer=2  !(-:14 min)
!  rdf_stride_inner=1
!/
!
!  ?-?-21/axel and nils: adapted from lucky.f90
!
