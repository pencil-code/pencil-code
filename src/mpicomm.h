...
!
  ...
  public :: mpisend_logical, mpisend_real, mpisend_int   !, mpisend_cmplx
...
! Variables
  ...
  public :: MPI_COMM_WORLD, MPI_COMM_GRID, MPI_COMM_XYPLANE, MPI_COMM_YZPLANE, MPI_INFO_NULL, lyang
