! $Id: ionization.f90,v 1.159 2004-03-24 11:21:39 mee Exp $
...
!ajwm  reworking to be independent of these things first
  real, public :: cs0=impossible, rho0=impossible
  real, public :: cs20=impossible, lnrho0=impossible
  logical, public :: lcalc_cp = .false.
  real, public :: gamma=impossible, gamma1=impossible
  real, public :: cp=impossible, cp1=impossible
!ajwm  can't use impossible else it breaks reading param.nml 
  real, public :: cs2bot=1., cs2top=1. 
