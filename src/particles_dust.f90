...
!
      if (lwr) then
        ...
        call farray_index_append('itauascalar', itauascalar)
        call farray_index_append('icondensationRate', icondensationRate)
        call farray_index_append('iwaterMixingRatio', iwaterMixingRatio)
      endif
!
