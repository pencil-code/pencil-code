...
!
  namelist /particles_init_pars/ &
      ...
      lreassign_strat_rhom, lparticlemesh_pqs_assignment, rpbeta_species, rpbeta
!
  namelist /particles_run_pars/ &
      ...
      lpscalar_sink, lsherwood_const, lnu_draglaw, nu_draglaw,lbubble, rpbeta_species, rpbeta
!
