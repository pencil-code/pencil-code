...
!  (moved to particles_sub by alexrichert)
!
      call init_particle_positions_velocities(f,fp,ineargrid,1,npar_loc)
!
...
!
!  Initialize particle positions and velocities (particles_sub)
!
          init_particle_positions_velocities(f,fp,ineargrid,npar_loc_old+1,npar_loc)
!
