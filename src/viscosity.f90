! $Id: viscosity.f90,v 1.2 2005-06-26 17:34:13 eos_merger_tony Exp $
...
!
      ...
      if (idiag_epsK/=0 .or. idiag_epsK2/=0 .or. idiag_epsK_LES/=0) &
          lpenc_diagnos(i_rho)=.true.
      if (idiag_epsK2/=0) lpenc_diagnos(i_uu)=.true.
