...
call copy_addr(iglobal_ext_bx,p_par(733)) ! int
call copy_addr(iglobal_ext_by,p_par(734)) ! int
call copy_addr(iglobal_ext_bz,p_par(735)) ! int
call copy_addr(iglobal_ext_ax,p_par(736)) ! int
call copy_addr(iglobal_ext_ay,p_par(737)) ! int
call copy_addr(iglobal_ext_az,p_par(738)) ! int
