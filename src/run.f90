...
!
  lpencil = lpenc_requested
  do i=1,npencils
        if(lpencil(i)) print*,"PC IS ACTIVE: ",i
  enddo
  if(lpencil(i_shock)) print*,"SHOCK IS ASKED FOR!\n"
  call initialize_gpu
! Load farray to gpu
...
call copy_addr(lfirst,p_par(22)) ! bool
...
call copy_addr(nt,p_par(34)) ! int
call copy_addr(itsub,p_par(35)) ! int
...
call copy_addr(iglobal_ext_bx,p_par(100)) ! int
call copy_addr(iglobal_ext_by,p_par(101)) ! int
call copy_addr(iglobal_ext_bz,p_par(102)) ! int
