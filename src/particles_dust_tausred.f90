...
module Particles
  ...
  namelist /particles_run_pars/ &
      ...
      ldragforce_gas, rhop_tilde, eps_dtog, tausmin, cdtp, &
...
!
      ...
      real :: tausp1_point, tausg1_point, eps_point, rho_point, np_point
...
!          
          do k=1,npar_loc
            ...
            call get_global_point(np_point,ix0,iy0,iz0,'np')
