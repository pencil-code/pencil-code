...
!*******************************************************************************
    subroutine calc_1d_diagnostics_hydro(p)
!
!   6-sep-19/MR: taken out from duu_dt
!
      use Diagnostics
...
!
      case ('damp_horiz_vel')
        ...
        if (lcartesian_coords) then
          prof_amp1=0.5*(tanh((z(n)-zbot)/wdamp)+1.)
          df(l1:l2,m,n,iux)=df(l1:l2,m,n,iux)-tau_diffrot1*prof_amp1*f(l1:l2,m,n,iux)**3
          df(l1:l2,m,n,iuy)=df(l1:l2,m,n,iuy)-tau_diffrot1*prof_amp1*f(l1:l2,m,n,iuy)**3
        endif
!
