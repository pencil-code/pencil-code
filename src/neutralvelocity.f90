...
!
      if (lwr) then
        ...
        write(3,*) 'i_unymax=',idiag_unymax
        write(3,*) 'i_unzmax=',idiag_unzmax
        write(3,*) 'i_unzrms=',idiag_unzrms
        write(3,*) 'i_unzrmaxs=',idiag_unzrmaxs
        write(3,*) 'i_unx2m=',idiag_unx2m
        write(3,*) 'i_uny2m=',idiag_uny2m
        write(3,*) 'i_unz2m=',idiag_unz2m
        write(3,*) 'i_unxunym=',idiag_unxunym
        write(3,*) 'i_unxunzm=',idiag_unxunzm
        write(3,*) 'i_unyunzm=',idiag_unyunzm
        write(3,*) 'i_unmx=',idiag_unmx
        write(3,*) 'i_unmy=',idiag_unmy
        write(3,*) 'i_unmz=',idiag_unmz
        write(3,*) 'i_unxpt=',idiag_unxpt
        write(3,*) 'i_unypt=',idiag_unypt
        write(3,*) 'i_unzpt=',idiag_unzpt
        write(3,*) 'i_unxmz=',idiag_unxmz
        write(3,*) 'i_unymz=',idiag_unymz
        write(3,*) 'i_unzmz=',idiag_unzmz
        write(3,*) 'i_unxmxy=',idiag_unxmxy
        write(3,*) 'i_unymxy=',idiag_unymxy
        write(3,*) 'i_unzmxy=',idiag_unzmxy
        write(3,*) 'i_un2mz=',idiag_un2mz
        write(3,*) 'i_unrmphi=',idiag_unrmphi
        write(3,*) 'i_unpmphi=',idiag_unpmphi
        write(3,*) 'i_unzmphi=',idiag_unzmphi
        write(3,*) 'i_un2mphi=',idiag_un2mphi
        write(3,*) 'i_unrmr=',idiag_unrmr
        write(3,*) 'i_unpmr=',idiag_unpmr
        write(3,*) 'i_unzmr=',idiag_unzmr
