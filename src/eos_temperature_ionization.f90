! $Id: eos_temperature_ionization.f90,v 1.57 2007-07-23 17:04:00 wlyra Exp $
...
!***********************************************************************
    subroutine bc_lnrho_hydrostatic_z_smooth(f,topbot)
      ...
      character (len=3) :: topbot
      real, dimension (mx,my,mz,mfarray) :: f
      call stop_it("bc_lnrho_hydrostatic_z_smooth: NOT IMPLEMENTED IN EOS_TEMP")
      if (NO_WARN) print*,f,topbot
...
!***********************************************************************
    subroutine bc_lnrho_hydrostatic_z_global(f,topbot)
      ...
      character (len=3) :: topbot
      real, dimension (mx,my,mz,mfarray) :: f
      call stop_it("bc_lnrho_hydrostatic_z_global: NOT IMPLEMENTED IN EOS_TEMP")
      if (NO_WARN) print*,f,topbot
...
!***********************************************************************
    subroutine bc_lnrho_hydrostatic_z_smooth_global(f,topbot)
      ...
      character (len=3) :: topbot
      real, dimension (mx,my,mz,mfarray) :: f
      call stop_it("bc_lnrho_hydrostatic_z_smooth_global: NOT IMPLEMENTED IN EOS_TEMP")
      if (NO_WARN) print*,f,topbot
