! $Id: density.f90,v 1.199 2005-08-19 21:26:31 theine Exp $
...
! PENCILS PROVIDED del6lnrho,hlnrho,sglnrho
!
!***************************************************************
...
!      
      if (ldiff_shock) then
        ...
        if (lfirst.and.ldt) diffus_diffrho=diffus_diffrho+diffrho_shock*p%shock*dxyz_2
