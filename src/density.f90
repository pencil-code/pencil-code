! $Id: density.f90,v 1.85 2003-05-30 16:08:19 mee Exp $
...
module Density
  ...
  integer :: i_ekin=0,i_rhom=0,i_totekin=0
...
!ajwm - here's the init call that needs sorting!
      ...
      case('planet')
        ...
        !
        call planet(amplrho,f,xx,yy,zz,eps_planet,radius_lnrho,gamma,cs20,widthlnrho)
...
!
      ...
      do iname=1,nname
        call parse_name(iname,cname(iname),cform(iname),'totekin',i_totekin)
