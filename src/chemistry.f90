...
!***********************************************************************
    ...
    if(allocated(low_coeff)) call copy_addr(low_coeff,p_par(97)) ! (3) (nreactions)
    if(allocated(high_coeff)) call copy_addr(high_coeff,p_par(98)) ! (3) (nreactions)
    if(allocated(troe_coeff)) call copy_addr(troe_coeff,p_par(99)) ! (3) (nreactions)
    if(allocated(a_k4)) call copy_addr(a_k4,p_par(100)) ! (nchemspec) (nreactions)
