...
!
  namelist /run_pars/ &
      ...
      crash_file_dtmin_factor, ltestperturb, eps_rkf, eps_rkf0, dtinc, dtdec, dtlimit, lshock_heat, &
...
!
        ...
        call read_namelist(read_dustvelocity_init_pars   ,'dustvelocity'   ,.true., loptest(loptional).or.(.not.ldustvelocity))
...
!
        ...
        call read_namelist(read_dustvelocity_run_pars   ,'dustvelocity'   ,.true., loptest(loptional).or.(.not.ldustvelocity))
