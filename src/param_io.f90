! $Id: param_io.f90,v 1.223 2006-02-28 09:35:24 nbabkovs Exp $ 
...
!
  ...
  namelist /init_pars/ &
       ...
       xyz_step,xi_step_frac,xi_step_width, &
       lcylindrical,init_loops, H_disk, L_disk, R_star, M_star, lextrapolate_bot_density,lderiv_top_velocity
  namelist /run_pars/ &
       ...
       lpencil_check,lpencil_check_diagnos_opti,lpencil_init, H_disk, L_disk, R_star, M_star
  contains
