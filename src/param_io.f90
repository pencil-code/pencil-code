! $Id: param_io.f90,v 1.234 2006-04-28 18:15:32 brandenb Exp $ 
...
!
  ...
  namelist /init_pars/ &
       ...
       lextrapolate_bot_density, ltop_velocity_kep, laccelerat_zone, ldecelerat_zone,lnstar_entropy,lnstar_T_const
  namelist /run_pars/ &
