...
#define eta1 (*((real *) p_par_magnetic[2-1]))
const int n_pars_energy=1;
...
const int n_pars_timestep=2;
 EXTERN void *p_par_timestep[n_pars_timestep];
 extern "C" void *__timestep_MOD_pushpars2c(void *(&p_par)[n_pars_timestep]);
