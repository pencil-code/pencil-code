...
AcReal max_diffus(AcReal ){return 0.0;};
/***********************************************************************************************/
bool
has_nans(AcMesh mesh_in);
...
#include "cmake_options.h"
  ...
  //printf("UU ASKED FOR: %d\n",acDeviceGetLocalConfig(acGridGetDevice())[AC_lpencil__mod__cdata][108]);
