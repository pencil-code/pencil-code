...
!
      ...
      if (nnamer>0) then
        if (lcylinder_in_a_box.or.lsphere_in_a_box) call allocate_phizaverages_names(nnamer)
      endif
      ...
      if (nnamerz>0) then
        if (lcylinder_in_a_box.or.lsphere_in_a_box) call allocate_phiaverages_names(nnamerz)
      endif
