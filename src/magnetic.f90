...
!
!  Muliply resistivity by Nyquist scale, for resistive time-step.
!
      if (lfirst.and.ldt) then
!
...
call copy_addr(b0_ext_z,p_par(1))
call copy_addr(t_bext,p_par(2))
call copy_addr(t0_bext,p_par(3))
call copy_addr(eta1_aniso,p_par(4))
call copy_addr(eta1_aniso_r,p_par(5))
call copy_addr(eta1_aniso_d,p_par(6))
call copy_addr(eta_shock,p_par(7))
call copy_addr(eta_shock2,p_par(8))
call copy_addr(alp_aniso,p_par(9))
call copy_addr(eta_aniso_bb,p_par(10))
call copy_addr(quench_aniso,p_par(11))
call copy_addr(eta_va,p_par(12))
call copy_addr(eta_j,p_par(13))
call copy_addr(eta_jrho,p_par(14))
call copy_addr(eta_min,p_par(15))
call copy_addr(etaj20,p_par(16))
call copy_addr(va_min,p_par(17))
call copy_addr(varms,p_par(18))
call copy_addr(rhomin_jxb,p_par(19))
call copy_addr(va2max_jxb,p_par(20))
call copy_addr(va2max_boris,p_par(21))
call copy_addr(cmin,p_par(22))
call copy_addr(omega_bz_ext,p_par(23))
call copy_addr(inclaa,p_par(24))
call copy_addr(d_smag,p_par(25))
call copy_addr(b_ext2,p_par(26))
call copy_addr(nu_ni1,p_par(27))
call copy_addr(hall_term,p_par(28))
call copy_addr(battery_term,p_par(29))
call copy_addr(hall_tdep_t0,p_par(30))
call copy_addr(hall_tdep_exponent,p_par(31))
call copy_addr(hhall,p_par(32))
call copy_addr(hall_zdep_exponent,p_par(33))
call copy_addr(eta_jump,p_par(34))
call copy_addr(eta_jump0,p_par(35))
call copy_addr(eta_jump1,p_par(36))
call copy_addr(etab,p_par(37))
call copy_addr(tau_relprof,p_par(38))
call copy_addr(tau_relprof1,p_par(39))
call copy_addr(dipole_moment,p_par(40))
call copy_addr(pm_smag1,p_par(41))
call copy_addr(va2power_jxb,p_par(42)) ! int
call copy_addr(iua,p_par(43)) ! int
call copy_addr(ilam,p_par(44)) ! int
call copy_addr(llorentzforce,p_par(45)) ! bool
call copy_addr(llorentz_rhoref,p_par(46)) ! bool
call copy_addr(linduction,p_par(47)) ! bool
call copy_addr(ldiamagnetism,p_par(48)) ! bool
call copy_addr(lcovariant_magnetic,p_par(49)) ! bool
call copy_addr(ladd_global_field,p_par(50)) ! bool
call copy_addr(lresi_eta_const,p_par(51)) ! bool
call copy_addr(lresi_eta_tdep,p_par(52)) ! bool
call copy_addr(lresi_eta_ztdep,p_par(53)) ! bool
call copy_addr(lresi_sqrtrhoeta_const,p_par(54)) ! bool
call copy_addr(lresi_eta_aniso,p_par(55)) ! bool
call copy_addr(lquench_eta_aniso,p_par(56)) ! bool
call copy_addr(lresi_etass,p_par(57)) ! bool
call copy_addr(lresi_hyper2,p_par(58)) ! bool
call copy_addr(lresi_hyper3,p_par(59)) ! bool
call copy_addr(lresi_hyper2_tdep,p_par(60)) ! bool
call copy_addr(lresi_hyper3_tdep,p_par(61)) ! bool
call copy_addr(lresi_hyper3_polar,p_par(62)) ! bool
call copy_addr(lresi_hyper3_mesh,p_par(63)) ! bool
call copy_addr(lresi_hyper3_csmesh,p_par(64)) ! bool
call copy_addr(lresi_hyper3_strict,p_par(65)) ! bool
call copy_addr(lresi_zdep,p_par(66)) ! bool
call copy_addr(lresi_ydep,p_par(67)) ! bool
call copy_addr(lresi_xdep,p_par(68)) ! bool
call copy_addr(lresi_rdep,p_par(69)) ! bool
call copy_addr(lresi_xydep,p_par(70)) ! bool
call copy_addr(lresi_hyper3_aniso,p_par(71)) ! bool
call copy_addr(lresi_eta_shock,p_par(72)) ! bool
call copy_addr(lresi_eta_shock2,p_par(73)) ! bool
call copy_addr(lresi_eta_shock_profz,p_par(74)) ! bool
call copy_addr(lresi_eta_shock_profr,p_par(75)) ! bool
call copy_addr(lresi_eta_shock_perp,p_par(76)) ! bool
call copy_addr(lresi_etava,p_par(77)) ! bool
call copy_addr(lresi_etaj,p_par(78)) ! bool
call copy_addr(lresi_etaj2,p_par(79)) ! bool
call copy_addr(lresi_etajrho,p_par(80)) ! bool
call copy_addr(lresi_shell,p_par(81)) ! bool
call copy_addr(lresi_smagorinsky,p_par(82)) ! bool
call copy_addr(lresi_smagorinsky_nusmag,p_par(83)) ! bool
call copy_addr(lresi_smagorinsky_cross,p_par(84)) ! bool
call copy_addr(lresi_anomalous,p_par(85)) ! bool
call copy_addr(lresi_spitzer,p_par(86)) ! bool
call copy_addr(lresi_cspeed,p_par(87)) ! bool
call copy_addr(lresi_vaspeed,p_par(88)) ! bool
call copy_addr(lalfven_as_aux,p_par(89)) ! bool
call copy_addr(lresi_magfield,p_par(90)) ! bool
call copy_addr(lresi_eta_proptouz,p_par(91)) ! bool
call copy_addr(lohmic_heat,p_par(92)) ! bool
call copy_addr(lneutralion_heat,p_par(93)) ! bool
call copy_addr(lj_ext,p_par(94)) ! bool
call copy_addr(lee_as_aux,p_par(95)) ! bool
call copy_addr(ladd_disp_current_from_aux,p_par(96)) ! bool
call copy_addr(lbb_as_aux,p_par(97)) ! bool
call copy_addr(ljj_as_aux,p_par(98)) ! bool
call copy_addr(ljxb_as_aux,p_par(99)) ! bool
call copy_addr(luxb_as_aux,p_par(100)) ! bool
call copy_addr(lugb_as_aux,p_par(101)) ! bool
call copy_addr(lbgu_as_aux,p_par(102)) ! bool
call copy_addr(lbdivu_as_aux,p_par(103)) ! bool
call copy_addr(lua_as_aux,p_par(104)) ! bool
call copy_addr(letasmag_as_aux,p_par(105)) ! bool
call copy_addr(ljj_as_comaux,p_par(106)) ! bool
call copy_addr(lbb_as_comaux,p_par(107)) ! bool
call copy_addr(lb_ext_in_comaux,p_par(108)) ! bool
call copy_addr(lbb_sph_as_aux,p_par(109)) ! bool
call copy_addr(lbext_curvilinear,p_par(110)) ! bool
call copy_addr(lsmooth_jj,p_par(111)) ! bool
call copy_addr(lambipolar_diffusion,p_par(112)) ! bool
call copy_addr(lcoulomb,p_par(113)) ! bool
call copy_addr(lvacuum,p_par(114)) ! bool
call copy_addr(loverride_ee,p_par(115)) ! bool
call copy_addr(loverride_ee2,p_par(116)) ! bool
call copy_addr(lignore_1rho_in_lorentz,p_par(117)) ! bool
call copy_addr(iedotx,p_par(118)) ! int
call copy_addr(iedotz,p_par(119)) ! int
call copy_addr(eta,p_par(120))
call copy_addr(eta_hyper2,p_par(121))
call copy_addr(eta_hyper3,p_par(122))
call copy_addr(eta_hyper3_mesh,p_par(123))
call copy_addr(eta_spitzer,p_par(124))
call copy_addr(eta_anom,p_par(125))
call copy_addr(eta_anom_thresh,p_par(126))
call copy_addr(eta_int,p_par(127))
call copy_addr(eta_ext,p_par(128))
call copy_addr(wresistivity,p_par(129))
call copy_addr(height_eta,p_par(130))
call copy_addr(eta_out,p_par(131))
call copy_addr(eta_cspeed,p_par(132))
call copy_addr(tau_aa_exterior,p_par(133))
call copy_addr(tauad,p_par(134))
call copy_addr(eta_zwidth,p_par(135))
call copy_addr(eta_rwidth,p_par(136))
call copy_addr(eta_width_shock,p_par(137))
call copy_addr(eta_zshock,p_par(138))
call copy_addr(eta_rwidth0,p_par(139))
call copy_addr(eta_rwidth1,p_par(140))
call copy_addr(eta_xshock,p_par(141))
call copy_addr(eta_r0,p_par(142))
call copy_addr(eta_r1,p_par(143))
call copy_addr(alphassm,p_par(144))
call copy_addr(j_ext_quench,p_par(145))
call copy_addr(b2_diamag,p_par(146))
call copy_addr(ampl_fcont_aa,p_par(147))
call copy_addr(llambda_aa,p_par(148))
call copy_addr(vcrit_anom,p_par(149))
call copy_addr(numag,p_par(150))
call copy_addr(b0_magfric,p_par(151))
call copy_addr(ekman_friction_aa,p_par(152))
call copy_addr(exp_epspb,p_par(153))
call copy_addr(ncr_quench,p_par(154))
call copy_addr(ampl_eta_uz,p_par(155))
call copy_addr(no_ohmic_heat_z0,p_par(156))
call copy_addr(no_ohmic_heat_zwidth,p_par(157))
call copy_addr(imp_alpha0,p_par(158))
call copy_addr(imp_halpha,p_par(159))
call copy_addr(c_light21,p_par(160))
call copy_addr(betamin_jxb,p_par(161))
call copy_addr(lweyl_gauge,p_par(162)) ! bool
call copy_addr(ladvective_gauge,p_par(163)) ! bool
call copy_addr(lupw_aa,p_par(164)) ! bool
call copy_addr(ladvective_gauge2,p_par(165)) ! bool
call copy_addr(lforcing_cont_aa,p_par(166)) ! bool
call copy_addr(iforcing_cont_aa,p_par(167)) ! int
call copy_addr(lkinematic,p_par(168)) ! bool
call copy_addr(lignore_bext_in_b2,p_par(169)) ! bool
call copy_addr(luse_bext_in_b2,p_par(170)) ! bool
call copy_addr(lmean_friction,p_par(171)) ! bool
call copy_addr(llocal_friction,p_par(172)) ! bool
call copy_addr(lambipolar_strong_coupling,p_par(173)) ! bool
call copy_addr(lhalox,p_par(174)) ! bool
call copy_addr(lno_ohmic_heat_bound_z,p_par(175)) ! bool
call copy_addr(lmagneto_friction,p_par(176)) ! bool
call copy_addr(limplicit_resistivity,p_par(177)) ! bool
call copy_addr(lncr_correlated,p_par(178)) ! bool
call copy_addr(lncr_anticorrelated,p_par(179)) ! bool
call copy_addr(ladd_efield,p_par(180)) ! bool
call copy_addr(lsld_bb,p_par(181)) ! bool
call copy_addr(la_relprof_global,p_par(182)) ! bool
call copy_addr(lmagnetic_slope_limited,p_par(183)) ! bool
call copy_addr(lboris_correction,p_par(184)) ! bool
call copy_addr(lnoinduction,p_par(185)) ! bool
call copy_addr(limp_alpha,p_par(186)) ! bool
call copy_addr(fac_sld_magn,p_par(187))
call copy_addr(ampl_efield,p_par(188))
call copy_addr(rhoref,p_par(189))
call copy_addr(rhoref1,p_par(190))
call copy_addr(lbext_moving_layer,p_par(191)) ! bool
call copy_addr(zbot_moving_layer,p_par(192))
call copy_addr(ztop_moving_layer,p_par(193))
call copy_addr(speed_moving_layer,p_par(194))
call copy_addr(edge_moving_layer,p_par(195))
call copy_addr(eta_shock_jump1,p_par(196))
call copy_addr(eta_tdep,p_par(197))
call copy_addr(arms,p_par(198))
call copy_addr(r2,p_par(199))
call copy_addr(gamma1,p_par(200))
call string_to_enum(string_enum_ambipolar_diffusion,ambipolar_diffusion)
call copy_addr(string_enum_ambipolar_diffusion,p_par(201)) ! int
call string_to_enum(string_enum_rdep_profile,rdep_profile)
call copy_addr(string_enum_rdep_profile,p_par(202)) ! int
call string_to_enum(string_enum_ihall_term,ihall_term)
call copy_addr(string_enum_ihall_term,p_par(203)) ! int
call copy_addr(b_ext,p_par(204)) ! real3
call copy_addr(b0_ext,p_par(205)) ! real3
call copy_addr(j_ext,p_par(206)) ! real3
call copy_addr(eta_aniso_hyper3,p_par(207)) ! real3
call copy_addr(lfrozen_bb_bot,p_par(208)) ! bool3
call copy_addr(lfrozen_bb_top,p_par(209)) ! bool3
call copy_addr(eta_xy,p_par(210)) ! (mx) (my)
call copy_addr(geta_xy,p_par(211)) ! (mx) (my) (3)
call copy_addr(a_relprof,p_par(212)) ! (nx) (ny) (nz) (3)
call copy_addr(eta_z,p_par(213)) ! (mz)
call copy_addr(geta_z,p_par(214)) ! (mz)
call copy_addr(eta_x,p_par(215)) ! (mx)
call copy_addr(geta_x,p_par(216)) ! (mx)
call copy_addr(eta_y,p_par(217)) ! (my)
call copy_addr(geta_y,p_par(218)) ! (my)
call copy_addr(feta_ztdep,p_par(219)) ! (mz)
call copy_addr(string_enum_borderaa,p_par(220)) ! int3
call copy_addr(bz_stratified,p_par(221)) ! (mz)
