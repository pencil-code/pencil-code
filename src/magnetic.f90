...
!
      do ixz=1,nnamexz
        ...
        call parse_name(ixz,cnamexy(ixz),cformxy(ixz),'bxbymxz',idiag_bxbymxz)
        call parse_name(ixz,cnamexy(ixz),cformxy(ixz),'bxbzmxz',idiag_bxbzmxz)
        call parse_name(ixz,cnamexy(ixz),cformxy(ixz),'bybzmxz',idiag_bybzmxz)
      enddo
!
