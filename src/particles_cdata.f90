...
!
  ...
  integer, parameter :: max_par_per_grid=int(floor(npar_maxp/real(nwgrid)))+1  ! ceiling needed?
...
!
  ...
  integer :: itaup=0 
  integer :: ixp0=0, iyp0=0, izp0=0,ippersist=0, iborn=0
  integer :: inucl_Se=0, inucl_T=0, inucl_mix_frac=0
  integer :: incol=0, iint_Se=0, iint_T=0, iint_mix_frac=0
  ...
  integer :: imskh = 0, itbrt = 0, itbpe = 0, itage = 0, imshg = 0, imech = 0
...
!
  ...
  logical :: ltemp_equip_simplified=.false., lcondspec_details=.false.
!
...
!
    ...
    logical :: lpp, lspecies, lnu, lcs
!
!  Interpolation policies:
!
    integer :: pol_uu, pol_oo, pol_TT, pol_rho, pol_gradTT, pol_bb, pol_ee
    integer :: pol_pp, pol_species, pol_nu, pol_cs
...
!
    ...
    real, dimension(:), allocatable :: interp_cs
!
!  Interpolation policies:
