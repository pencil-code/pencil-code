...
!
  ...
  character (len=labellen) :: IO_strategy="collect_x_y"
!
...
!
      ...
      if (.not. lseparate_persist) call fatal_error ('io_collect_x_y', &
...
!
      use Mpicomm, only: lroot, globalize_x_y, mpisend_real, mpirecv_real
!
...
!  10-Feb-2012/Bourdin.KIS: coded
!
      use Mpicomm, only: lroot, localize_x_y, mpisend_real, mpirecv_real, mpibcast_real
