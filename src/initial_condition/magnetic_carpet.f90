                ...
                do l = 1, mx, 1
                    f(l,m,n,iax) = ampl * (&
                        ...
                        * (y(m) + 8) + 2. * (x(l) ** 2 + ((y(m) - 8) ** 2) + (z(n)&
                        ...
                        / 2.) * (y(m) - 8) + 2. * ((x(l) - 2.) ** 2 + ((y(m) -&
                        8) ** 2) + (z(n) + 0.85) ** 2) ** (-3.0 / 2.) * (y(m) - 8)&
                        + 2. * ((x(l) - 8.) ** 2 + (y(m) ** 2) + (z(n) + 0.85) **&
                        ...
                        * ((x(l) + 10.) ** 2 + (y(m) ** 2) + (z(n) + 0.85) ** 2) **&
                        (-3.0 / 2.) * (y(m)) + 2. * ((x(l) + 6.) ** 2 + (y(m) **&
                        2) + (z(n) + 0.85) ** 2) ** (-3.0 / 2.) * (y(m)) + 2. * (x(l)&
                        ** 2 + (y(m) ** 2) + (z(n) + 0.85) ** 2) ** (-3.0 / 2.)&
                        * (y(m)) + 2. * ((x(l) + 2.) ** 2 + (y(m) ** 2) + (z(n)&
                        + 0.85) ** 2) ** (-3.0 / 2.) * (y(m)) + 2. * ((x(l) - 2.)&
                        ** 2 + (y(m) ** 2) + (z(n) + 0.85) ** 2) ** (-3.0 / 2.) *&
                        (y(m)) + 2. * ((x(l) - 8.) ** 2 + ((y(m) - 8) ** 2) + (z(n)&
                        + 0.85) ** 2) ** (-3.0 / 2.) * (y(m) - 8) + 2. * ((x(l)&
                        - 6.) ** 2 + ((y(m) - 8) ** 2) + (z(n) + 0.85) ** 2) ** (-3.0&
                        / 2.) * (y(m) - 8))
                    f(l,m,n,iay) = ampl * (&
                         -2. * ((x(l) - 2.) ** 2 + y(m) ** 2 + (z(n) + 0.85) ** 2)&
                        ** (-3.0 / 2.) * (x(l) - 2.) - 2. * ((x(l) - 8.) ** 2 +&
                        (y(m) - 8.) ** 2 + (z(n) + 0.85) ** 2) ** (-3.0 / 2.) * (x(l)&
                        - 8.) - 2. * ((x(l) - 6.) ** 2 + (y(m) - 8.) ** 2 + (z(n)&
                        + 0.85) ** 2) ** (-3.0 / 2.) * (x(l) - 6.) - 2. * ((x(l)&
                        - 10.) ** 2 + (y(m) - 8.) ** 2 + (z(n) + 0.85) ** 2) **&
                        (-3.0 / 2.) * (x(l) - 10.) - 2. * ((x(l) - 8.) ** 2 + (y(m)&
                        ...
                        ** 2 + (y(m) + 8.) ** 2 + (z(n) + 0.85) ** 2) ** (-3.0 /&
                        2.) * (x(l) + 6.) - 2. * (x(l) ** 2 + (y(m) + 8.) ** 2 +&
                        (z(n) + 0.85) ** 2) ** (-3.0 / 2.) * x(l) - 2. * ((x(l) +&
                        2.) ** 2 + (y(m) + 8.) ** 2 + (z(n) + 0.85) ** 2) ** (-3.0&
                        / 2.) * (x(l) + 2.) - 2. * ((x(l) - 2.) ** 2 + (y(m) + 8.)&
                        ** 2 + (z(n) + 0.85) ** 2) ** (-3.0 / 2.) * (x(l) - 2.)&
                        - 2. * (x(l) ** 2 + (y(m) - 8.) ** 2 + (z(n) + 0.85) ** 2)&
                        ** (-3.0 / 2.) * x(l) - 2. * ((x(l) + 2.) ** 2 + (y(m) -&
                        8.) ** 2 + (z(n) + 0.85) ** 2) ** (-3.0 / 2.) * (x(l) + 2.)&
                        - 2. * ((x(l) - 2.) ** 2 + (y(m) - 8.) ** 2 + (z(n) + 0.85)&
                        ** 2) ** (-3.0 / 2.) * (x(l) - 2.) - 2. * ((x(l) - 8.)&
                        ** 2 + y(m) ** 2 + (z(n) + 0.85) ** 2) ** (-3.0 / 2.) * (x(l)&
                        - 8.) - 2. * ((x(l) - 6.) ** 2 + y(m) ** 2 + (z(n) +&
                        0.85) ** 2) ** (-3.0 / 2.) * (x(l) - 6.) - 2. * ((x(l) - 10.)&
                        ** 2 + y(m) ** 2 + (z(n) + 0.85) ** 2) ** (-3.0 / 2.)&
                        * (x(l) - 10.) - 2. * ((x(l) + 8.) ** 2 + y(m) ** 2 + (z(n)&
                        + 0.85) ** 2) ** (-3.0 / 2.) * (x(l) + 8.) - 2. * ((x(l)&
                        + 10.) ** 2 + y(m) ** 2 + (z(n) + 0.85) ** 2) ** (-3.0 /&
                        2.) * (x(l) + 10.) - 2. * ((x(l) + 6.) ** 2 + y(m) ** 2 +&
                        (z(n) + 0.85) ** 2) ** (-3.0 / 2.) * (x(l) + 6.) - 2. * (x(l)&
                        ** 2 + y(m) ** 2 + (z(n) + 0.85) ** 2) ** (-3.0 / 2.)&
                        * x(l) - 2. * ((x(l) + 2.) ** 2 + y(m) ** 2 + (z(n) + 0.85)&
                        ** 2) ** (-3.0 / 2.) * (x(l) + 2.) + 0.1D0 * x(l))
                    f(l,m,n,iaz) = 0
                enddo          
            enddo          
        enddo
