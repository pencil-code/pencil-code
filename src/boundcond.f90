...
!
              ...
              elseif (ip_ok) then
                ...
                case ('ss')
                  ...
                  call bc_symset_x(f,+1,topbot,j,VAL=fbcx(j,topbot))
                case ('sds')
                ...
                case ('a2v')
                  ...
                  ! BCX_DOC: $f_{N+i}=2 f_{N}-f_{N-i}$;
                  ! BCX_DOC: implies $f''(x_0)=0$
                  call bc_sym_x(f,-1,topbot,j,REL=.true.,VAL=fbcx(j,topbot))
                case ('a2r')
                ...
                case ('st')
                  ...
                  call bc_sym_x_ydep(f,-1,topbot,j,REL=.true.,val=bc_st(t))
                case ('der')
...
!
            ...
            if (ip_ok) then
              ...
              case ('ss')
                ...
                call bc_symset_y(f,+1,topbot,j,VAL=fbcy(j,topbot))
              case ('sds')
...
!AB: wasn't this a mistake??
              ...
              case ('set')
                ...
                call bc_sym_y(f,-1,topbot,j,REL=.true.,VAL=fbcy(j,topbot))
              case ('sse')
                ! BCY_DOC:  symmetry, set boundary value
                call bc_sym_y(f,+1,topbot,j,VAL=fbcy(j,topbot))
              case ('sep')
                ! BCY_DOC: set boundary value
                call bc_sym_y(f,-1,topbot,j,REL=.true.,VAL=fbcy(j,topbot),VAL2=fbcy_1(j,topbot),VAL4=fbcy_2(j,topbot))
              case ('e1')
...
!
          ...
          do j=ivar1,ivar2
            ...
            if (ip_ok) then
              ...
              case ('sep')
                ! BCZ_DOC: set boundary value
                call bc_sym_z(f,-1,topbot,j,REL=.true.,VAL=fbcz(j,topbot),VAL2=fbcz_1(j,topbot),VAL4=fbcz_2(j,topbot))
              case ('der')
