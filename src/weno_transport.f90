...
!
      vsig=abs(fq(:,m,n, iux))
      vsig=max( cshift(vsig,-3), cshift(vsig,-2), cshift(vsig,-1), cshift(vsig, 0), &
...
!
      vsig=max( abs(fq(:,m-3,n,iuy)), abs(fq(:,m-2,n,iuy)), abs(fq(:,m-1,n,iuy)), &
                abs(fq(:,m  ,n,iuy)), &
...
!
      vsig=max( abs(fq(:,m,n-3,iuz)), abs(fq(:,m,n-2,iuz)), abs(fq(:,m,n-1,iuz)), &
                abs(fq(:,m,n  ,iuz)), &
...
!
      f = 0.5 * (f + df)
!
      b1 = 13.0/12.0 * (f(-2,:) - 2.0*f(-1,:) +     f(0,:))**2 + &
           1.0 / 4.0 * (f(-2,:) - 4.0*f(-1,:) + 3.0*f(0,:))**2
!
      b2 = 13.0/12.0 * (f(-1,:) - 2.0*f(0,:) + f(+1,:))**2 + &
           1.0 / 4.0 * (f(-1,:)              - f(+1,:))**2
!
      b3 = 13.0/12.0 * (    f(0,:) - 2.0*f(+1,:) + f(+2,:))**2 + &
...
!
      f = f - df
!
      b1 = 13.0/12.0 * (f(+3,:) - 2.0*f(+2,:) +     f(+1,:))**2 + &
           1.0 / 4.0 * (f(+3,:) - 4.0*f(+2,:) + 3.0*f(+1,:))**2
!
      b2 = 13.0/12.0 * (f(+2,:) - 2.0*f(+1,:) + f(0,:))**2 + &
           1.0 / 4.0 * (f(+2,:)               - f(0,:))**2
!
      b3 = 13.0/12.0 * (    f(+1,:) - 2.0*f(0,:) + f(-1,:))**2 +  &
