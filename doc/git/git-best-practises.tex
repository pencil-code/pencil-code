...
\end{lstlisting}
because that makes it quite difficult to understand the history of commits.
...
and, voilà: you did something that you might not have intended.
...
As a consequence, tools like the GitHub the commit emails will fail,
