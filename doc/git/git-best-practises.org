...
GitHub SVN bridge.
   ...
   #+begin_example
     Iomsn                o Added time series for the fixed points.
     Jörn Warnecke        o add new time step calculation for slope limited diffusion
     Philippe Bourdin     o Added comments about which line will not work with which compiler version.
     ...
     mrheinhardt          │ │ │ o added a phase to enforced vertical shear profile; correction in calcula
     ...
     mrheinhardt          │ │ │ │ o more corrections for slope-limited diffusion
     Philippe Bourdin     │ │ │ o─┘ Removed ugly hack with 'lstart' and introduced new 'lparam_nml' to indica
     mrheinhardt          │ │ │ o some corrections to the slope-limited diffusion scheme
     ...
     mrheinhardt          │ │ │ o more for flux-limited diffusion
     Frederick Gent       │ │ │ M─┐ Merge branch 'master' of https://github.com/pencil-code/pencil-code
     mrheinhardt          │ │ │ │ o added 4th order scheme which calculates first derivative on centered
     ...
     mrheinhardt          o │ │ │ │ │ added empty file to fix the auto-test
