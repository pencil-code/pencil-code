...
GitHub SVN bridge.
   ...
   #+begin_example
     Jörn Warnecke     o           add new time step calculation for slope limited diffusion
     Philippe Bourdin  o           Added comments about which line will not work
     Simo Tuomisto     M─┐         Merge branch 'master' of https://github.com/pencil-code/pencil-code
     Frederick Gent    │ o         Revised data to account for correction to chi-therm
     ...
     Philippe Bourdin  │ │ o       We explicitly want to allow missing namelists
     Frederick Gent    │ M─│─┐     Merge branch 'master' of https://github.com/pencil-code/pencil-code
     Jörn Warnecke     │ │ o─┘     fixed some errors
     Frederick Gent    │ M─│─┐     Merge branch 'master' of https://github.com/pencil-code/pencil-code
     ...
     Philippe Bourdin  │ │ │ o─┘   Removed "array temporaries", see also 2a73f3cea323
     mrheinhardt       │ │ │ o     added a phase to enforced vertical shear profile;
   ...
   #+begin_example
     Jörn Warnecke     o          add new time step calculation for slope limited diffusion
     Philippe Bourdin  o          Added comments about which line will not work
     Simo Tuomisto     M─┐        Merge one commit into master
     Frederick Gent    o │        Revised data to account for correction to chi-therm
     Philippe Bourdin  o │        Lets see if the new IO modules work everywhere as expected...
     Frederick Gent    M─│─┐      Third try at merging equilibrium in to master
     Philippe Bourdin  o │ │      We explicitly want to allow missing namelists
     Frederick Gent    │ │ M─┐    Second try at merging hydrostatic equilibrium into master
     Jörn Warnecke     o─│─┘ │    fixed some errors
     Frederick Gent    │ │   M─┐  First try at merging hydrostatic equilibrium into master
     Jörn Warnecke     o─│───┘ │  removed some doubling of some subroutine
     Jörn Warnecke     o │     │  more on slope limited diffusion
     Illa R. Losada    M─│─┐   │  Merge current helicity tensor into master
     Axel Brandenburg  o │ │   │  added Hill vortex rain as forcing
     Philippe Bourdin  M─│─│─┐ │  Merge fix for last broken autotest
     Philippe Bourdin  │ │ │ o │  Finally fixed the last still broken autotest
     Jörn Warnecke     o │ │ │ │  More correction and additions for the slope limited diffusion,
     Philippe Bourdin  o─│─│─┘ │  Removed "array temporaries", see also 2a73f3cea323
     mrheinhardt       o │ │   │  added a phase to enforced vertical shear profile;
     Illa R. Losada    │ │ o   │  Adding components of the current helicity tensor.
