...
- Review of :file:`pencil-code/python/pencil/TO_DO_LIST.txt`

- Array order convention: Current array order is [z, y, x]. Consider changing to [x, y, z] (standard convention), but this may break existing scripts.

- Shall we mark obsolete items in :ref:`python-decisions` as obsolete, or remove them entirely?

- Official Pencil Python package.
