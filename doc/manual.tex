...
%%  CVS: $Id: manual.tex,v 1.258 2004-07-07 16:28:54 brandenb Exp $
%%  Description:
...
%\date{$ $Date: 2004-07-07 16:28:54 $ $,~ $ $Revision: 1.258 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2004-07-07 16:28:54 $ $,~ $ $Revision: 1.258 $ $}\\
...
%%%
\subsubsection{ifort does not complain about errors}
\index{ifort}

ifort for some reason does not complain about declaring the same variable
more than once. This is getting very annoying. Does anyone know the
secret words that will make ifort complain about these errors?

\medskip

tOnY replied:\\
{\em
Well that took Google all of about 1 second!

Err...
  \url{http://zampano.zam.kfa-juelich.de/software/inteldoc/f_qrg/index.htm}

\begin{Verbatim}
-check all     Default is -check none
Or are you doing this already?

Perhaps also:
-stand f95 or -stand f90
               Compile messages about non-standard
               Fortran code.

Also Tobi have you tried using
  -fcommon
as an optimisation with ifort?

"Tells the compiler to treat common symbols as global de&#64257;nitions and to
allocate memory for each symbol at compile time. This may permit the compiler
to use the more efficient GP-relative addressing mode when accessing the
symbol."
\end{Verbatim}

I wonder what that does to all those uu, bb... etc. pencils declared in pde?
Faster memory access perhaps?
}
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2004-07-07 16:28:54 $ $,~ $ $Revision: 1.258 $ $}
...
$ $Id: manual.tex,v 1.258 2004-07-07 16:28:54 brandenb Exp $ $}
