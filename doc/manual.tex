...
initialisation and is always read in.
...
state; to get more insight, you should have alook at the code.
...
\midrule
  ...
  \var{lperi}  & determine the geometry of the box. All three are vectors
                 ...
                 the box size.
                 \var{lperi} specifies whether a direction is conidered
...
$ $Id: manual.tex,v 1.38 2002-07-01 08:26:10 dobler Exp $ $}
...
% LocalWords:  tarball unix somwhere cd gunzip xf mhd passwd CVSROOT cshrc sh
