...
%%  CVS: $Id: manual.tex,v 1.155 2003-04-22 17:35:45 tarek Exp $
%%  Description:
...
\date{$ $Date: 2003-04-22 17:35:45 $ $,~ $ $Revision: 1.155 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-04-22 17:35:45 $ $,~ $ $Revision: 1.155 $ $}
...
If you keep this frequency too high, the code will spend a lot of timeon
I/O, in particular for big large jobs; a too low frequency makes it
...
These files are numbered consecutively from $N=1$ upwards and for long
...
\begin{equation} \label{Eq-S-traceless}
  {\mathsf S}_{ij} = \frac{1}{2}\left({\partial u_i\over\partial x_j}
                 ...
                 -\frac{2}{3} \delta_{ij}\grad\Div\uv\right)
\end{equation}
...
For a monatomic gas it can be shown that the bulk viscosity vanishes.  Here
the bulk viscosity is introduced for numerical purposes only.
...
made between required and optional where by a parameter requires a setting if
the default value would give an invalid or degenerate case for the initial
condition.
...
$ $Id: manual.tex,v 1.155 2003-04-22 17:35:45 tarek Exp $ $}
