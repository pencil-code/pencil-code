...
\item Unless you are a privileged users with write access, you can
  download the code with the comand
  ...
  something like
  \code{svn checkout https://pencil-code.googlecode.com/svn/trunk/ pencil-code --username AxelBrandenburg},
  where \name{AxelBrandenburg} is to be replaced by {\it your} google name.
