...
{\em
Since you use \cmd{FC=mpif90} there must definitely be something
...
In the directory \file{\${PENCIL_HOME}/samples/helical-MHDturb/K_VECTORS/}
...
\file{\${PENCIL_HOME}/samples/helical-MHDturb/idl/generate_kvectors.pro}
