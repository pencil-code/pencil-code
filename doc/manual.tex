...
%%  CVS: $Id: manual.tex,v 1.111 2002-09-30 09:45:24 dobler Exp $
%%  Description:
...
\begin{verbatim}
  ...
  /
\end{verbatim}
--- in this example, the name of the namlist is \name{init_pars}, and we
...
are just given for demonstartion purposes here --- in fact a periodic box
...
the Numerical Recipies \cite{NR}, rather than the compiler's builtin
generator.
...
$ $Id: manual.tex,v 1.111 2002-09-30 09:45:24 dobler Exp $ $}
