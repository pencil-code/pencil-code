...
%%  CVS: $Id: manual.tex,v 1.389 2008-03-31 23:23:22 dobler Exp $
%%  Description:
...
%\date{$ $Date: 2008-03-31 23:23:22 $ $,~ $ $Revision: 1.389 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2008-03-31 23:23:22 $ $,~ $ $Revision: 1.389 $ $}\\
...
\begin{equation}
  N_y \ =\ \frac{\pi - \arccos \Bigl(1-\dfrac{\delta}{h}\Bigr)}
                {\arccos \Bigl(1-\dfrac{\delta}{h}\Bigr)}
      \ \approx\  \pi\, \sqrt{\dfrac{h}{2\,\delta}}
\end{equation}
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2008-03-31 23:23:22 $ $,~ $ $Revision: 1.389 $ $}
...
$ $Id: manual.tex,v 1.389 2008-03-31 23:23:22 dobler Exp $ $}
