...
%%  CVS: $Id: manual.tex,v 1.103 2002-09-24 03:09:33 brandenb Exp $
%%  Description:
...
can set the environment variable \env{PENCIL_HOME} explicitly before you
...
The directory \file[runs/]{runs} contains individual run directories, grouped in
...
\item \file[density.pro]{tmp/density.pro},
      \file[hydro.pro]{tmp/hydro.pro}, \file[entropy.pro]{tmp/entropy.pro},
      \file[magnetic.pro]{tmp/magnetic.pro}
...
On big Beowulf machines, a group of nodes is connected with a switch
...
\subsection{Random magnetic fields: \code{initaa='gaussian-noise'}}
...
\subsection{Beltrami fields: \code{initaa='Beltrami-z'}}
...
\quad g_z=-\nu_{\rm g}^2z
\end{equation}
where $\nu_{\rm g}$ vertical epicyclic frequency. For a Keplerian
accretion disc, $\nu_{\rm g}=\Omega$, but not for galactic discs.
...
$ $Id: manual.tex,v 1.103 2002-09-24 03:09:33 brandenb Exp $ $}
