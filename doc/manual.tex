...
%%  CVS: $Id: manual.tex,v 1.200 2003-10-10 15:01:42 dobler Exp $
%%  Description:
...
\date{$ $Date: 2003-10-10 15:01:42 $ $,~ $ $Revision: 1.200 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-10-10 15:01:42 $ $,~ $ $Revision: 1.200 $ $}
...
\end{alltt}
Using double precision may be important in turbulence runs where
...
% wd: you shouldn't use explicit KIND values anyway
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2003-10-10 15:01:42 $ $,~ $ $Revision: 1.200 $ $}
...
\midrule
  ...
  \var{z2} [$1.$]
               & specific to the solar convection case
                 ...
                 $z_2 < z < z_{\rm top}$. \\
  \var{nu_epicycle} [$1.$]
               & \label{nu-epicycle-init}
                 \emph{Axel or Nils, please comment me!}\\
%
\midrule
...
\midrule
  ...
  \var{wdamp} [$0.2$]
               & permanently damp motions in $|\xv|>r_{\rm damp}$ with
                 ...
                 \var{wdamp}. \\
  \var{frec_ux} [$100.$], \\
  \var{ampl_osc_ux} [$1.\EE{-3}$]
               & Something concerning the weird boundary condition
                 \option{osc} (which is most probably also undocumented).
                 \emph{Nils, please document me correctly and do the same
                   for \var{frec_lnrho} etc.!}.\\
%
\midrule
...
\midrule
  ...
  \var{nu_epicycle} [start]
               & see p.~\pageref{nu-epicycle-init}.\\
%
\midrule
  \multicolumn{2}{c}{Namelist \name{shear_run_pars}} \\
\midrule
...
$ $Id: manual.tex,v 1.200 2003-10-10 15:01:42 dobler Exp $ $}
