...
%%  CVS: $Id: manual.tex,v 1.174 2003-06-24 16:19:08 theine Exp $
%%  Description:
...
\date{$ $Date: 2003-06-24 16:19:08 $ $,~ $ $Revision: 1.174 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-06-24 16:19:08 $ $,~ $ $Revision: 1.174 $ $}
...
Toby Heinemann added the Feautrier method for radiative transfer as well as
hydrogen ionization.
...
\hfill{\normalsize\rm {$ $Date: 2003-06-24 16:19:08 $ $,~ $ $Revision: 1.174 $ $}}}
...
Solving for $T$ gives
\begin{align}
\frac{3}{2}\ln\frac{T}{T_0}&={\textstyle\frac{\frac{s}{s_0}
+\sum_ix_i\ln\frac{x_i}{\rho_i}}{x_{\rm tot}}}
+\ln\rho-\frac{5}{2} \\
&={\textstyle\frac{\frac{s}{s_0}
+(1-y)\ln\frac{1-y}{\rho_{\rm H}}+y\ln\frac{y^2}{\rho_{\rm e}\rho_{\rm p}}
+x_{\rm He}\ln\frac{x_{\rm He}}{\rho_{\rm He}}}{x_{\rm tot}}}
+\ln\rho-\frac{5}{2}
\end{align}
...
\[
f(y)=\ln\left[\frac{\rho_{\rm e}}{\rho}\left(\frac{T(y)}{T_0}\right)^{3/2}\frac{1-y}{y^2}\right]-\frac{T_0}{T(y)}
\]
...
$ $Id: manual.tex,v 1.174 2003-06-24 16:19:08 theine Exp $ $}
