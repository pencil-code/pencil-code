...
flux density, $\Phi$ is the scalar potential,
...
are present and prevent wiggles the vector potential.
Although the terms $A_{x,x}$, $A_{y,y}$, and $A_{z,z}$ are absent in $\Bv$,
the can affect the result if the terms are large compared with $\Bv$.
