...
%%  CVS: $Id: manual.tex,v 1.160 2003-05-30 16:08:19 mee Exp $
%%  Description:
...
\date{$ $Date: 2003-05-30 16:08:19 $ $,~ $ $Revision: 1.160 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-05-30 16:08:19 $ $,~ $ $Revision: 1.160 $ $}
...
\midrule
  ...
  \var{totekin} & $\int_V{1\over2}\varrho\uv^2\, dv$ \\
%
\midrule
  \multicolumn{2}{c}{Module \name{entropy.f90}} \\
\midrule
  \var{eth} & $\left<\varrho e\right>$ \\
  \var{toteth} & $\int_V\varrho e\,dv$ \\
...
$ $Id: manual.tex,v 1.160 2003-05-30 16:08:19 mee Exp $ $}
