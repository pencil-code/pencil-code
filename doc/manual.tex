...
%%  CVS: $Id: manual.tex,v 1.307 2005-10-24 06:59:54 dobler Exp $
%%  Description:
...
%\date{$ $Date: 2005-10-24 06:59:54 $ $,~ $ $Revision: 1.307 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2005-10-24 06:59:54 $ $,~ $ $Revision: 1.307 $ $}\\
...
\begin{table}[htbp]
  ...
  \caption{Units of magnetic field and temperature for some choices of
    ...
    (\ref{unit-T}).
    Values are for a monoatomic gas ($\gamma=5/3$) of mean atomic
...
For a monoatomic gas it can be shown that the bulk viscosity vanishes.
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2005-10-24 06:59:54 $ $,~ $ $Revision: 1.307 $ $}
...
$ $Id: manual.tex,v 1.307 2005-10-24 06:59:54 dobler Exp $ $}
