...
\begin{tabular}{lll}
  ...
  joern.warnecke  & \htmladdnormallink{J\"orn Warnecke}{http://www.nordita.org/~joern/} & Nordita, Stockholm \\
...
download it via \name{svn}.
In Iran, Google Code is not currently available.
...
which contains the mobile numbers of many developers.
...
2048 &Lindgren&0.0013&$1024^2\times2048$&magn/noentro&32x64&16-jul-12& AB \\
    \bottomrule
  \end{longtable}
  %\end{tabular}
    \end{small}
