...
%%  CVS: $Id: manual.tex,v 1.129 2002-10-09 02:07:45 brandenb Exp $
%%  Description:
...
Sect.~\ref{S-start-params} and \ref{S-all-run-params}), and the list of
...
\file{data/proc*/var.dat}. The value if the latest time is saved in a
...
terms of $\varrho$ and $s/c_p$ to give
\begin{equation}
  \frac{D\uv}{Dt}
...
%    \begin{tabular}{rllrlrll}
   ...
   8 & Mhd   & 1.46 &$160^2\times40$& nomagn/entro&46 Mb& 7-oct-02& AB \\
...
\midrule
  ...
  \var{ruxm} & $\left<\varrho u_x\right>$ (mean $x$-momentum) \\
  \var{ruym} & $\left<\varrho u_y\right>$ (mean $y$-momentum) \\
  \var{ruzm} & $\left<\varrho u_z\right>$ (mean $z$-momentum) \\
%
\midrule
  \multicolumn{2}{c}{Module \name{density.f90}} \\
\midrule
...
\midrule
  ...
  \var{bmx} & $\left<\left<\Bv\right>_{yz}^2\right>^{1/2}$ (energy of $yz$-averaged mean field) \\
  \var{bmy} & $\left<\left<\Bv\right>_{xz}^2\right>^{1/2}$ (energy of $xz$-averaged mean field) \\
  \var{bmz} & $\left<\left<\Bv\right>_{xy}^2\right>^{1/2}$ (energy of $xy$-averaged mean field) \\
%
\midrule
  \multicolumn{2}{c}{Module \name{pscalar.f90}} \\
\midrule
...
$ $Id: manual.tex,v 1.129 2002-10-09 02:07:45 brandenb Exp $ $}
