...
%%  CVS: $Id: manual.tex,v 1.121 2002-10-03 19:30:03 dobler Exp $
%%  Description:
...
Sec.~\ref{S-start-params} and \ref{S-all-run-params}), and the list of
...
This visocus operator is not physically consistent (linear and angular
...
\item[Mhd:] EV6 Compaq cluster with 4 CPUs per node;
  ...
  OSF1 4.0;
  native MPI
\item[Sander:] Origin 3000
\item[Rasmussen:] Origin 3000
...
\midrule
  \var{inituu} [\code{'zero'}]
               & initialization of velocity. Currently valid choices are
                 ...
                 \item[\code{`Alfven-circ-x'}] (circularly polarised
                 ...
                 \item[\code{`up-down'}] (flow upwards in one spot,
                   downwards in another; not soneloidal).
                 \end{description}
                 \\
  \var{ampluu} [$0.$]
...
\midrule
  \var{initaa} [\code{'zero'}]
               & initialization of magnetic field (vector potential).
                 ...
                 \item[\code{`Alfven-z'}] (???),
                 \item[\code{`Alfvenz-rot'}] (???),
                 \item[\code{`Alfven-test'}] (???),
                 \item[\code{`Alfven-circ-x'}] (circularly polarised
                   Alfven wave in x direction),
                 \item[\code{`'}] (),
...
$ $Id: manual.tex,v 1.121 2002-10-03 19:30:03 dobler Exp $ $}
