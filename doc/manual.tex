...
%%  CVS: $Id: manual.tex,v 1.124 2002-10-04 17:14:40 brandenb Exp $
%%  Description:
...
\item[cvsci_run] Similar to \cmd{cvs-add-rundir}, but it also checks in
  ...
  \file{data/n.dat} and \file{data/index.pro} for subsequent processing in
...
\item[x] Check the execution of the current run: prints legend and the last
 few lines of the \file{n.dat} file. It also appends this result to a file
...
In the equation of motion, the pressure gradient term,
$\varrho^{-1}\boldsymbol\nabla p$, can be expressed in
terms of $\varrho$ and $s/c_{\rm p}$ to give
\begin{equation}
  \frac{D\uv}{Dt}
...
\end{equation}
The sound speed squared, $\cs^2 = \gamma p/\varrho$, is obtained
in the form
\begin{equation}
c_{\rm s}^2=c_{\rm s0}^2\exp\left[(\gamma-1)\ln\varrho/\varrho_0
+\gamma s/c_p\right],
\end{equation}
where $\gamma=c_p/c_v$ the ratio of specific heats or \emph{adiabatic index},
...
\Div\left[\varrho c\uv-\varrho{\cal D}{\partial c\over\partial t}\right].
\end{equation}
...
$ $Id: manual.tex,v 1.124 2002-10-04 17:14:40 brandenb Exp $ $}
