...
%%  CVS: $Id: manual.tex,v 1.272 2004-08-20 20:31:21 brandenb Exp $
%%  Description:
...
%\date{$ $Date: 2004-08-20 20:31:21 $ $,~ $ $Revision: 1.272 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2004-08-20 20:31:21 $ $,~ $ $Revision: 1.272 $ $}\\
...
\begin{tabular}{lll}
  ...
  theine & \htmladdnormallink{Tobias (Tobi) Heinemann}{http://www.nordita.dk/~theine/} & University of Calgary\\
  ...
  mcmillan & \htmladdnormallink{David McMillan}{http://www.mas.ncl.ac.uk/~ndgm5/} & University of Newcastle\\
  mattias & \htmladdnormallink{Mattias Christensson}{http://www.nordita.dk/~mattias/} & Nordita\\
  ...
  ajohan & \htmladdnormallink{Anders Johansen}{http://www.astro.ku.dk/~ajohan/} & Nordita and University of Copenhagen\\
\end{tabular}
...
\code{:pserver:\$USER@norserv.nordita.dk:/home/brandenb/CVS}
...
Haugen, N. E. L., Brandenburg, A., \& Mee, A. J.\pmn{2004}
{Mach number dependence of the onset of dynamo action}
(\astroph{0405453})

Brandenburg, A., \& Multam\"aki, T.\pjourS{2004}{Int.\ J.\ Astrobiol.}
{How long can left and right handed life forms coexist?}
(\qbio{0407008})

Heinemann, T., Dobler, W., Nordlund, \AA., \& Brandenburg, A.\tana{2004}
{Radiative transfer in decomposed domains}

Dobler, W., Stix, M., \& Brandenburg, A.\tapj{2004}
{Convection and magnetic field generation in fully convective stars}
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2004-08-20 20:31:21 $ $,~ $ $Revision: 1.272 $ $}
...
%    \begin{tabular}{rllrlrll}
  ...
  16 & s40s17& 0.39 & $128^3$ & magn/noentro &4x4/ifc6& 20-aug-04 & AB \\
  ...
  64 & giga  & 0.166& $512^3$ & magn/noentro &4x16, 64*173MB& 10-jul-03 & AB \\
  64 & Gridur& 0.25 & $256^3$ & magn/noentro &        & 19-aug-02 & NE \\
  64 & Ukaff & 0.17 & $512^3$ & magn/noentro &        & 21-may-02 & AB \\
 128 & fe1   & 0.44 & $256^3$ & nomagn/entro/rad8/ion &  4x32  & 10-mar-04 & TH \\
 ...
 256 & s40p17& 0.028& $1024^3$& magn/noentro &4x32/ifc6&20-aug-04 & AB \\
    \bottomrule
  \end{longtable}
  %\end{tabular}
    \end{small}
...
The ``wiggles'' in $\ln\varrho$ in (high-order centered-difference)
...
This behavior is hardly influenced by the boundary conditions on
$\ln\varrho$ at all.
...
\midrule
  ...
  \var{lread_oldsnap_nomag} [\code{F}]
               & if set \code{T}, the old snapshot from a non-magnetic run
                 ...
                 conditions. This allows one to let a hydrodynamic run
                 relax before adding a magnetic field.\\
...
\midrule
  ...
  \var{beta1m} & $\left<\Bv^2/(2\mu_0 p)\right>$ \quad(mean inverse plasma beta)\\
  \var{beta1max} & $\max[\Bv^2/(2\mu_0 p)]$ \quad(maximum inverse plasma beta)\\
...
$ $Id: manual.tex,v 1.272 2004-08-20 20:31:21 brandenb Exp $ $}
