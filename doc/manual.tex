...
%%  CVS: $Id: manual.tex,v 1.141 2002-11-28 09:51:22 dobler Exp $
%%  Description:
...
The Dec Fortran optimizer has occasional problems with \var{nompicomm.f90}:
\begin{Verbatim}
...
{\em
  ...
  optimization (part of the \var{-O5} optimization), via:
  \begin{Verbatim}
...
$ $Id: manual.tex,v 1.141 2002-11-28 09:51:22 dobler Exp $ $}
