...
%%  CVS: $Id: manual.tex,v 1.57 2002-07-18 23:49:36 brandenb Exp $
%%  Description:
...
\item the mean entropy \var{ssm}$=\left<s/c_p\right>$;
...
\begin{table}[htb]
  ...
  \vspace{12pt}
  \begin{tabular}{l@{\quad}l@{\quad}ccccccccc}
    \toprule
    scheme            & \multicolumn{3}{c}{intermediate fractions of $\delta t$}
                                      & $\alpha_2$
                                                 & $\alpha_3$
                                                            & $\beta_1$
                                                                    &$\beta_2$
...
\subsection{Equation of motion (\var{ivisc}=2)}
...
If \var{ivisc}=1, it is assumed that 
$\mu \equiv \varrho\nu = \const$ everywhere; in that
case the input parameter $\nu$ is used to give the value of $\mu$.
...
$ $Id: manual.tex,v 1.57 2002-07-18 23:49:36 brandenb Exp $ $}
