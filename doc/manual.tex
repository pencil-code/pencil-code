...
% -- mutual drag force --
Yang, C.-C., \& Johansen, A.\ppapjs{2016}
...
in order to test the correctnes of your changes to these configuration files.
...
%    \begin{tabular}{rllrlrll}
  ...
  36 &scylla &0.097&  $72^3$ & magn/noentro & 1x6x6  &  8-may-16 & AB \\
...
By default, the field is solenoidal inless one puts
...
By default, \var{initpower2=-5/3}, corresponding to a Kolmogov spectrum.
