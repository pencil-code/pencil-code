...
%%  CVS: $Id: manual.tex,v 1.217 2003-11-22 16:59:45 mcmillan Exp $
%%  Description:
...
%\date{$ $Date: 2003-11-22 16:59:45 $ $,~ $ $Revision: 1.217 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-11-22 16:59:45 $ $,~ $ $Revision: 1.217 $ $}\\
...
\paragraph{Azimuthal averages}
Azimuthal averages are controlled by the file \file{phiaver.in} as
follows.



\paragraph{Time averages}
Time averages are controlled by the averaging time $\tau_{\rm avg}$ (set
by the parameter \var{tavg}), and by the settings in the file
\file[ctimeavg.local]{src/ctimeavg.local}
...
boundary conditions are unkown and \file{start.x} will then fill the ghost
...
(typcially, you will get an `internal compilr error' during compilation of
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2003-11-22 16:59:45 $ $,~ $ $Revision: 1.217 $ $}
...
$ $Id: manual.tex,v 1.217 2003-11-22 16:59:45 mcmillan Exp $ $}
