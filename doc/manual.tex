...
%%  CVS: $Id: manual.tex,v 1.167 2003-06-13 15:43:11 brandenb Exp $
%%  Description:
...
\date{$ $Date: 2003-06-13 15:43:11 $ $,~ $ $Revision: 1.167 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-06-13 15:43:11 $ $,~ $ $Revision: 1.167 $ $}
...
\begin{equation}
  I(\tau) = I_0(\tau) e^{-\tau}
            + \int\limits_0^\tau e^{-(\tau-\tau')} S(\tau')\,d\tau' \; .
\end{equation}
Using a generalisation of the trapezoidal rule,
\begin{eqnarray}
  \int\limits_0^\tau e^{-(\tau-\tau')} f(\tau')\,d\tau'
  &\approx& \int\limits_0^\infty e^{-(\tau-\tau')}
              \left[ f(0) + \frac{f(\tau){-}f(0)}{\tau}\,\tau'
              \right] \; d\tau'\\
  &=&       (1{-}e^{-\tau}) f(\tau)
          - \frac{1 - e^{-\tau}(1{+}\tau)}{\tau}[f(\tau)-f(0)]
  \; ,
\end{eqnarray}
...
\midrule
  ...
  \var{lwrite_aux} [\code{F}]
               & if set \code{T}, auxilliary variables (those calculated at
...
$ $Id: manual.tex,v 1.167 2003-06-13 15:43:11 brandenb Exp $ $}
