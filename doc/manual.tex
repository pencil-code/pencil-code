...
\midrule
  ...
  \var{wdamp} [$0.2$],
               & permanently damp motions in $|\xv|<r_{\rm dampint}$ 
                 ...
                 \var{wdamp}. \\
  \var{ampl_forc} [$0.$], 
               & amplitude of the ux-forcing on the vertical boundaries 
                 that is of the form 
                 $u\_x(t)=ampl\_forc*sin(kx\_forc*x)*cos(w\_forc*t)$
                 [must be used in connection with bcz=`g' and 
                 force_lower_bound=`ux_time' or force_upper_bound=`ux_time'] \\
  \var{kx_forc} [$0.$], 
