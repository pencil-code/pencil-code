...
\begin{figure}[htb]
  ...
  \includegraphics%
    [width=.99\textwidth,keepaspectratio]%
    {github-timetrace}
  \caption{Check-in frequency on the github page as a function of time; see
  \url{https://github.com/pencil-code/pencil-code/graphs/contributors}
  }
  \label{github-timetrace}
\end{figure}
% ---------------------------------------------------------------------- %
...
\begin{tabular}{lll}
  ...
  rplasson & \htmladdnormallink{Raphael Plasson}{https://github.com/pencil-code/pencil-code} & Nordita \\
  ...
  joishi  & \htmladdnormallink{Jeff S.\ Oishi}{http://cms.jsoishi.org/} & Kavli Inst., Particle Astrophys. Cosm.\\
  joern.warnecke  & \htmladdnormallink{J\"orn Warnecke}{http://www.nordita.org/~warnecke/} & MPS, G{\"o}ttingen \\
  JenSchober & \htmladdnormallink{Jennifer Schober}{https://jennifer-schober.com/} & Lausanne \\
  ...
  ccyang & \htmladdnormallink{Chao-Chin Yang}{http://www.astro.lu.se/~ccyang/} & University of Nevada \\
  ...
  michiel.lambrechts & \htmladdnormallink{Michiel Lambrechts}{http://pc500.astro.lu.se/~michiel/} & Lund Observatory\\
...
Again, as a courtesy to those developers, we suggest to contact them,
...
You will also need the NumPy, matplotlib, h5py and Tk library.
...
Another way of installing libraries, particularly on a cluster without root
privileges you can use pip or pip3: \texttt{pip install h5py} or \texttt{pip3 install h5py}.
...
\item
  ...
  One option will be to navigate to the path of the existing 
...
\item
  ...
  end of \file{\$PENCIL\_HOME/python/pencil/files/remesh.py}.
