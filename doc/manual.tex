...
do the following\footnote{This is done automatically by the \cmd{pc_mkdatadir}
...
\begin{table}
  ...
  \midrule
    ...
    Intel                 & \texttt{ifort}    & \texttt{-O3}                        & \texttt{icc}       & \texttt{-O3 -DFUNDERSC=1}\\
    PGI                   & \texttt{pgf95}    & \texttt{-O4}                        & \texttt{pgcc}      & \texttt{-O3 -DFUNDERSC=1}\\
    ...
    IBM XL                & \texttt{xlf95}    & \texttt{-qsuffix=f=f90 -O3}         & \texttt{xlc}       & \texttt{-O3 -DFUNDERSC=0}\\
  \midrule
    \emph{outdated:}       &                   &                                     &                    & \\
    IRIX Mips             & \texttt{f90}      & \texttt{-64 -O3 -mips4}             & \texttt{cc}        & \texttt{-O3 -64 -DFUNDERSC=1}\\
    Compaq                & \texttt{f90}      & \texttt{-fast -O5 }                 & \texttt{cc}        & \texttt{-O3 -DFUNDERSC=1}\\
  \bottomrule
  \end{tabular}
\end{table}
...
Please refert to Sect.~\ref{S-make-flags}, Table~\ref{Tab-compiler-options}.
