...
add the line \code{INITIAL\_CONDITION=initial\_condition/myinitialcondition.f90}
to your \file{src/Makefile.local} file. Here, \file{myinitialcondition.f90} is the
