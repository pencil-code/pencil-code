...
Copyright \copyright{} 2001--2008 Wolfgang Dobler \& Axel Brandenburg
\bigskip
...
It is limited for the case of different resolution when one direction is
an integer multiple of the other. So, it can be done for

\code{Nx = n*Ny}

Unfortunately, for some applications one wants \code{Nx < Ny}. I experimented
