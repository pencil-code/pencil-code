...
%%  CVS: $Id: manual.tex,v 1.219 2003-11-24 08:29:51 brandenb Exp $
%%  Description:
...
%\date{$ $Date: 2003-11-24 08:29:51 $ $,~ $ $Revision: 1.219 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-11-24 08:29:51 $ $,~ $ $Revision: 1.219 $ $}\\
...
\begin{enumerate}
\item variable vector \verb|f| [\var{mx},\var{my},\var{mz}]
\item time $t$ [1], coordinate vectors $x$ [mx], $y$ [my], $z$ [mz],
...
The file \file[phiavg.pro]{\$PENCIL_HOME/idl/phiavg.pro}
demonstrates how to read and visualize azimuthal averages in \name{IDL}.
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2003-11-24 08:29:51 $ $,~ $ $Revision: 1.219 $ $}
...
$ $Id: manual.tex,v 1.219 2003-11-24 08:29:51 brandenb Exp $ $}
