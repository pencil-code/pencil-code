...
%%  CVS: $Id: manual.tex,v 1.241 2004-03-31 06:08:24 ajohan Exp $
%%  Description:
...
%\date{$ $Date: 2004-03-31 06:08:24 $ $,~ $ $Revision: 1.241 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2004-03-31 06:08:24 $ $,~ $ $Revision: 1.241 $ $}\\
...
\end{equation}
Here $P_{\rm sat}$ is the saturated vapour pressure of the monomer. Currently
only water ice has been implemented in the code.
\\ \\
All dust species fulfil the continuity equation
\begin{equation}
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2004-03-31 06:08:24 $ $,~ $ $Revision: 1.241 $ $}
...
$ $Id: manual.tex,v 1.241 2004-03-31 06:08:24 ajohan Exp $ $}
