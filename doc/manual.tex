...
%%  CVS: $Id: manual.tex,v 1.400 2008-07-26 06:11:01 brandenb Exp $
%%  Description:
...
%\date{$ $Date: 2008-07-26 06:11:01 $ $,~ $ $Revision: 1.400 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2008-07-26 06:11:01 $ $,~ $ $Revision: 1.400 $ $}\\
...
\item Get the password for anonymous \name{CVS} access to the {\sc Pencil Code}
  ...
  continue to use it.\footnote{%
    ...
    \code{setenv CVSROOT :pserver:\$USER@svn.nordita.org:/var/cvs/brandenb},
...
\item Set your environment variable \env{CVSROOT}:
  \begin{small}
  \begin{alltt}
  \prompt{csh> } setenv CVSROOT :pserver:anonymous@svn.nordita.org:/var/cvs/pencil-public \
  \end{alltt}
  \end{small}
  or (if you are running \name{bash} or \name{Bourne shell})
  \begin{small}
  \begin{alltt}
  \prompt{sh> } CVSROOT=:pserver:anonymous@svn.nordita.org:/var/cvs/pencil-public
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2008-07-26 06:11:01 $ $,~ $ $Revision: 1.400 $ $}
...
$ $Id: manual.tex,v 1.400 2008-07-26 06:11:01 brandenb Exp $ $}
