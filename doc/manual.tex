...
%%  CVS: $Id: manual.tex,v 1.108 2002-09-27 16:37:11 brandenb Exp $
%%  Description:
...
%\newcommand{\sectionbreak}{\clearpage} %(AB: starts new page for new section)
...
To update a code with little effort it is best to use \name{CVS}.
Occasionally we make a tarball of the current \name{CVS} repository
available, but with \name{CVS} you can update those too.
...
\item Download the tarball from
  \path{http://www.nordita.dk/data/brandenb/pencil-code/download/pencil-code_X.tar.gz}
...
!
&init_pars
  cvsid='$Id: manual.tex,v 1.108 2002-09-27 16:37:11 brandenb Exp $',
  random_gen='nr_f90'
/
&hydro_init_pars
/
...
$ $Id: manual.tex,v 1.108 2002-09-27 16:37:11 brandenb Exp $ $}
