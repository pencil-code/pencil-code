...
%%  CVS: $Id: manual.tex,v 1.120 2002-10-02 20:12:08 dobler Exp $
%%  Description:
...
\subsection{\file{datadir.in}}
If this file exists, it must contain the name of the data directory,
i.\,e.~the directory where all results are written.
If \file{datadir.in} doe not exist, the data directory is \file{data/}.
...
\file{reference.out}:
\begin{alltt}
  \prompt{unix> } diff data/n.dat reference.out
\end{alltt}
...
\paragraph{\file[n.dat]{data/n.dat}}
...
and, parallel to this, to the file \file[n.dat]{data/n.dat}.
...
$ $Id: manual.tex,v 1.120 2002-10-02 20:12:08 dobler Exp $ $}
...
% LocalWords:  setenv cvs cvspass code's dP sourceme mkdir tmp struct Weyl
