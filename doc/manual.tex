...
%%  CVS: $Id: manual.tex,v 1.74 2002-07-31 23:28:20 brandenb Exp $
%%  Description:
...
%     \option:  An option (command line or simialr):
...
\paragraph{Note 1}
The \code{<IDL_DEFAULT>} meachnism does not work for IDL versions 5.2 or
older. In this case, you will have to edit the path manually, ora adapt
...
$ $Id: manual.tex,v 1.74 2002-07-31 23:28:20 brandenb Exp $ $}
...
% LocalWords:  nygrid nzgrid ccc widthss ttrans brandenb Nils Pariev tcsh ls ln
% LocalWords:  cincinnatus CEST mx mz lnrho pf pararellism nprocy ncpus nprocz
