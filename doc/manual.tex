...
%%  CVS: $Id: manual.tex,v 1.138 2002-11-26 15:01:44 ngrs Exp $
%%  Description:
...
{\em
  ...
  optisation (part of the -O5 optimisation), via:
  \begin{Verbatim}
    #OPTFLAGS=-fast -O5 -notransform_loops
  \end{Verbatim}
  This has not been made standard in \file{Makefile}, 
  as it can cause some slowdown: e.g.
  %a increase of time/timestep/meshpoint from 2.67 to 289 microsec,
  an increase from 2.67 to 289 ${\mu\rm s}/{\rm pt\;\;step}$,
  for the \file{runs/forced/hel128f}, 
...
$ $Id: manual.tex,v 1.138 2002-11-26 15:01:44 ngrs Exp $ $}
