...
%%  CVS: $Id: manual.tex,v 1.369 2007-08-22 05:23:36 brandenb Exp $
%%  Description:
...
%\date{$ $Date: 2007-08-22 05:23:36 $ $,~ $ $Revision: 1.369 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2007-08-22 05:23:36 $ $,~ $ $Revision: 1.369 $ $}\\
...
\begin{equation}
  \frac{\partial s}{\partial t} = \frac{1}{\rho T}\mathbf{RHS} - \uv\grad s \nonumber
\end{equation}
is replaced by
\begin{equation}
\frac{\partial\ln T}{\partial t} =\frac{1}{c_v\rho T}\mathbf{RHS}
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2007-08-22 05:23:36 $ $,~ $ $Revision: 1.369 $ $}
...
$ $Id: manual.tex,v 1.369 2007-08-22 05:23:36 brandenb Exp $ $}
