...
If a variable does not affect control-flow it is often preferable to have the variables not trigger recompilation and it would helpful to add these cases to the code. So in the case you are running such spectrums of runs and are annoyed by the constant need of recompilation please do change the variable to not need the recompilation.
% ---------------------------------------------------------------------- %
