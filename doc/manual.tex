...
%%  CVS: $Id: manual.tex,v 1.397 2008-06-27 16:05:04 dhruba Exp $
%%  Description:
...
%\date{$ $Date: 2008-06-27 16:05:04 $ $,~ $ $Revision: 1.397 $ $}
...
<<<<<<< manual.tex
  \emph{$ $Date: 2008-06-27 16:05:04 $ $,~ $ $Revision: 1.397 $ $}\\
=======
  \emph{$ $Date: 2008-06-27 16:05:04 $ $,~ $ $Revision: 1.397 $ $}\\
>>>>>>> 1.396
...
<<<<<<< manual.tex
  dintrans & \htmladdnormallink{Boris
Dintrans}{http://www.ast.obs-mip.fr/dintrans} &  Observatoire Midi-Pyr\'en\'ees, Toulouse\\
dhruba & \htmladdnormallink{Dhrubaditya
Mitra}{http://www.maths.qmul.ac.uk/~dhruba} &  Queen Mary College, London\\
=======
...
Lyra, W., Johansen, A., Klahr, H., \& Piskunov, N. \yana{2008}{479}{}
...
\item Set your environment variable \env{CVSROOT}:
  \begin{small}
  \begin{alltt}
  \prompt{csh> } setenv CVSROOT :pserver:anonymous@cvs.nordita.dk:/var/cvs/pencil-public \
  \end{alltt}
  \end{small}
  or (if you are running \name{bash} or \name{Bourne shell})
  \begin{small}
  \begin{alltt}
  \prompt{sh> } CVSROOT=:pserver:anonymous@cvs.nordita.dk:/var/cvs/pencil-public
...
\item Go to wherever you want the code:
  ...
  and populates it with the {\sc Pencil Code}'s subdirectories.
...
bugs/  CVS/     dx/   lib/  misc/     README  sourceme.csh  src/         www/
\end{verbatim}
...
the streamwise direction, $z$ is in the spanwise direction and the walls
...
\section*{APPENDIX
<<<<<<< manual.tex
  \hfill\normalsize\rm$ $Date: 2008-06-27 16:05:04 $ $,~ $ $Revision: 1.397 $ $}
=======
  \hfill\normalsize\rm$ $Date: 2008-06-27 16:05:04 $ $,~ $ $Revision: 1.397 $ $}
>>>>>>> 1.396
...
<<<<<<< manual.tex
$ $Id: manual.tex,v 1.397 2008-06-27 16:05:04 dhruba Exp $ $}
=======
$ $Id: manual.tex,v 1.397 2008-06-27 16:05:04 dhruba Exp $ $}
>>>>>>> 1.396
