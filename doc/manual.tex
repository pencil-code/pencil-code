...
%%  CVS: $Id: manual.tex,v 1.370 2007-08-25 07:43:17 bingert Exp $
%%  Description:
...
%\date{$ $Date: 2007-08-25 07:43:17 $ $,~ $ $Revision: 1.370 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2007-08-25 07:43:17 $ $,~ $ $Revision: 1.370 $ $}\\
...
\index{pretend_lnTT}
By setting \emph{pretend_lnTT=T} the temperature is used instead of the
entropy. 

With this choice the entropy equation
\begin{equation}
  \frac{\partial s/c_p}{\partial t} = \frac{1}{c_p\rho T }\mathbf{RHS} - \uv\grad s \nonumber
\end{equation}
is replaced by
\begin{equation}
\frac{\partial\ln T}{\partial t} =\frac{\gamma}{c_p\rho T}\mathbf{RHS}
            -\left(\gamma-1\right) \Div \uv - \uv\cdot \grad \ln T \nonumber
\end{equation}
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2007-08-25 07:43:17 $ $,~ $ $Revision: 1.370 $ $}
...
$ $Id: manual.tex,v 1.370 2007-08-25 07:43:17 bingert Exp $ $}
