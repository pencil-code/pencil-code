...
%%  CVS: $Id: manual.tex,v 1.254 2004-06-17 20:59:15 dobler Exp $
%%  Description:
...
%\date{$ $Date: 2004-06-17 20:59:15 $ $,~ $ $Revision: 1.254 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2004-06-17 20:59:15 $ $,~ $ $Revision: 1.254 $ $}\\
...
We introduce a non-equidistant grid $z_i$ (so far only implemented for the
vertical direction) as a function $=z(\zeta)$ of an equidistant grid
$\zeta_i$ with grid spacing $\Delta\zeta = 1$.
Therefor the first derivative can be calculated by
...
\var{grid_func}, \var{coef_grid} and \var{zeta_grid0} define the function
$z(\zeta)$.
...
For \code{grid_function='sinh'}, the $z(\zeta)$ is given by
\begin{equation}
  z(\zeta)
  = z_0 - L_z \frac{\sinh a(\zeta_0-\zeta)}
                   {\sinh a(\zeta_n-\zeta)-\sinh a(\zeta_0-\zeta)} \; .
\end{equation}
...
\begin{Verbatim}
  &init_pars
    ...
    ! zeta_grid0 = 0.           ! default anyway
/
\end{Verbatim}
The parameter \var{coef_grid} represents $a$; the bottom height $z_0$ and
the total box height $L_z$ are taken from \var{xyz0} and \var{Lxyz} as in
the equidistant case.
If you want the linear part of the $\sinh$ profile at a non-zero height,
you can set \var{zeta_grid0} to a value $\zeta_0$ different from zero.
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2004-06-17 20:59:15 $ $,~ $ $Revision: 1.254 $ $}
...
$ $Id: manual.tex,v 1.254 2004-06-17 20:59:15 dobler Exp $ $}
