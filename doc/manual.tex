...
%%  CVS: $Id: manual.tex,v 1.251 2004-06-02 16:37:02 bingert Exp $
%%  Description:
...
%\date{$ $Date: 2004-06-02 16:37:02 $ $,~ $ $Revision: 1.251 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2004-06-02 16:37:02 $ $,~ $ $Revision: 1.251 $ $}\\
...
% ---------------------------------------------------------------------- %
\subsection{Using non equdistant grid}

The non equidistant grid z=z($\zeta$) in the vertical direction is a function of a equidistant grid with 
a gridspace of one.\\
Therefor the first derivative is calculated by\\
\begin{equation}
\frac{df}{dz}=\frac{df}{d\zeta}\frac{d\zeta}{dz}=\frac{1}{z'}f'
\end{equation}
and the second derivative by\\
\begin{equation}
\frac{d^2f}{dz^2}=\frac{1}{z'^2}f''-\frac{z''}{z'^3}f'
\end{equation}
The non equidistant grid is implemented only for the vertical
direction right now. The function is choosen to be\\
\begin{equation}
z(\zeta)=z_0 - L_z \frac{\sinh{a(\zeta_0-\zeta)}}{\sinh{a(\zeta_n-\zeta)}-\sinh{a(\zeta_0-\zeta)}}
\end{equation}
To select the non equidistant grid set grid_func='sinh' in start.in
There you can also set the coefficient $a$ by setting
'coef_grid'. If you start at a non zero height you have to set
'zeta_grid0' too. 
...
the popular parameterizations for radiative losses, Kramer's opacity,
Spitzer's conductivities or ionization, which implies well-defined
...
{\em
  ...
  \item One of the variables for \name{make} has a space appended to it,
    ...
    \cmd{CHRIAL=nochiral\textvisiblespace}), in which case the compiler
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2004-06-02 16:37:02 $ $,~ $ $Revision: 1.251 $ $}
...
$ $Id: manual.tex,v 1.251 2004-06-02 16:37:02 bingert Exp $ $}
...
% LocalWords:  Kramer's Myr Spitzer's Kippenhahn Weigert Remeshing remeshing
% LocalWords:  phiaver
