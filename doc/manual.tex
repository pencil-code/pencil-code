...
%%  CVS: $Id: manual.tex,v 1.214 2003-11-20 16:43:57 dobler Exp $
%%  Description:
...
\usepackage[dvipdfm]{hyperref}  % load after titlesec, or else (with dvipdfm)
                                % the \section links are one or two pages off
%\usepackage{makeidx}
...
%\date{$ $Date: 2003-11-20 16:43:57 $ $,~ $ $Revision: 1.214 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-11-20 16:43:57 $ $,~ $ $Revision: 1.214 $ $}\\
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2003-11-20 16:43:57 $ $,~ $ $Revision: 1.214 $ $}
...
$ $Id: manual.tex,v 1.214 2003-11-20 16:43:57 dobler Exp $ $}
