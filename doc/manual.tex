...
%%  CVS: $Id: manual.tex,v 1.184 2003-07-15 11:27:49 nilshau Exp $
%%  Description:
...
\date{$ $Date: 2003-07-15 11:27:49 $ $,~ $ $Revision: 1.184 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-07-15 11:27:49 $ $,~ $ $Revision: 1.184 $ $}
...
where
\[
  K_x = \frac{2\pi}{N_x}k_x \, ,\qquad
  K_y = \frac{2\pi}{N_y}k_y \, ,\qquad
  K_z = \frac{2\pi}{N_z}k_z \, ,
\]
and 
\[
   1 \le k_x\frac{L}{2 \pi} \le N_x \, ,\qquad
   1 \le k_y\frac{L}{2 \pi} \le N_y \, ,\qquad
   1 \le k_z\frac{L}{2 \pi} \le N_z \, ,
\]
...
Running the code will now create the files: \\ 
\name{sfu-1.dat}, \name{sfu-2.dat}, \name{sfu-3.dat} (velocity), \\ 
\name{sfb-1.dat}, \name{sfb-2.dat}, \name{sfb-3.dat} (magnetic field), \\ 
\name{sfz1-1.dat}, \name{sfz1-2.dat}, \name{sfz1-3.dat} (first Elsasser), \\ 
\name{sfz2-1.dat}, \name{sfz2-2.dat}, \name{sfz2-3.dat} (second Elsasser), \\ 
...
\hfill{\normalsize\rm {$ $Date: 2003-07-15 11:27:49 $ $,~ $ $Revision: 1.184 $ $}}}
...
$ $Id: manual.tex,v 1.184 2003-07-15 11:27:49 nilshau Exp $ $}
