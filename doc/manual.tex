...
%%  CVS: $Id: manual.tex,v 1.71 2002-07-26 12:10:01 brandenb Exp $
%%  Description:
...
%     \kbd:      type \kbd{M-x comment-region}                              %AB: key bindings?
%     \key:      press \key{F1}
%     \samp:     \samp{a}, \samp{e}, \samp{i}, \samp{o}, \samp{u}           %AB: sample??
%     \var:      is determined by \var{ivisc}
%     \env:      this sets \env{CVSROOT}
%     \file:     written to \file{~/tmp/var.dat}
%     \command:  use \command{rm -f *} at your own risk                     %AB: this isn't used anywhere!?!
%     \option:   use CVS with the option \option{-q}
%     \dfn:      A \dfn{definition} is a specification sufficiently obfuscated
%                to be misunderstood 
%     \acronym:  should we call the code \acronym{PROMPT}?                  %AB: this isn't used anywhere!?!
%     \url:      \url{http://www.nowhere.net/second_page.html}
%     \email:    \email{nobody@nowhere.nil}                                 %AB: this isn't used anywhere!?! (because we used url)
%
...
\paragraph{Note 1}
If you  don't want to rely on the \file{sourceme.\{c,\}sh} scripts' (quite
...
\paragraph{Note 2}
The second time you source \file{sourceme.\{c,\}sh}, it will not add
...
$ $Id: manual.tex,v 1.71 2002-07-26 12:10:01 brandenb Exp $ $}
