...
%%  CVS: $Id: manual.tex,v 1.42 2002-07-08 05:52:22 brandenb Exp $
%%  Description:
...
Thus, when using \var{initlnrho='polytropic\_simple'} we get
\begin{equation}
\ln\rho/\rho_0=m
...
and
\begin{equation}
s/c_{\rm p}=m\left({\Gamma\over\gamma}-1\right)
\ln c_{\rm s}^2/c_{\rm s0}^2
\end{equation}
\begin{equation}
...
$ $Id: manual.tex,v 1.42 2002-07-08 05:52:22 brandenb Exp $ $}
