...
%%  CVS: $Id: manual.tex,v 1.135 2002-10-31 12:32:08 dobler Exp $
%%  Description:
...
the timestep.
The $\delta t^{-1/2}$ dependence ensures that the forcing is
...
\end{equation}
For $0<\sigma<1$, the forcing function has fractional helicity;'footnote{
  WD: fractional helicity $\sigma$?
}
...
$ $Id: manual.tex,v 1.135 2002-10-31 12:32:08 dobler Exp $ $}
