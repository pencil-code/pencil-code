...
%%  CVS: $Id: manual.tex,v 1.349 2006-11-17 15:53:04 mee Exp $
%%  Description:
...
%\date{$ $Date: 2006-11-17 15:53:04 $ $,~ $ $Revision: 1.349 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2006-11-17 15:53:04 $ $,~ $ $Revision: 1.349 $ $}\\
...
and its slightly smaller counter part are the only full size 3D arrays in
...
area for each timestepped variable on top of the current state storred in
...
$\rm{mz}$ large the wasted storage becomes negligable.
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2006-11-17 15:53:04 $ $,~ $ $Revision: 1.349 $ $}
...
%    \begin{tabular}{rllrlrll}
   ...
   4 & Luci  & 1.81 &  $64^3$ & magn/noentro &        & 28-oct-06 & AB \\
  ...
  16 & Lenn  & 0.284& $128^3$ & magn/noentro &        & 28-oct-06 & AB \\
...
\begin{Verbatim}
  ...
  ;; behaviour is apparently a long-known bug the fix for which wasn't
...
coder has recognised this fact then make it explicit by adding the 
...
$ $Id: manual.tex,v 1.349 2006-11-17 15:53:04 mee Exp $ $}
