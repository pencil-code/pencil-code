...
%%  CVS: $Id: manual.tex,v 1.191 2003-08-08 20:06:29 dobler Exp $
%%  Description:
...
\date{$ $Date: 2003-08-08 20:06:29 $ $,~ $ $Revision: 1.191 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-08-08 20:06:29 $ $,~ $ $Revision: 1.191 $ $}
...
You can use the script \file[autotest]{bin/autotest} to automatically run
...
\hfill{\normalsize\rm {$ $Date: 2003-08-08 20:06:29 $ $,~ $ $Revision: 1.191 $ $}}}
...
\begin{table}[htb]
  ...
  \caption{Sums $\sqrt{4\pi}Y_l^m(\vartheta_i,\varphi_i)$ for special
    ...
    i.e.~the eight face diagonals that are not in the horizonatal plane.
  }
  \label{Tab-Ylm-sums}
  \footnotesize
...
$ $Id: manual.tex,v 1.191 2003-08-08 20:06:29 dobler Exp $ $}
...
% LocalWords:  Raphson trans horizonatal Ylm rrr Coord diag Stegun acroread cgs
