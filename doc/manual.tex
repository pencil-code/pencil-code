...
%%  CVS: $Id: manual.tex,v 1.47 2002-07-13 16:36:21 dobler Exp $
%%  Description:
...
\item Localize the Makefile (see \S \ref{adapt-mkfile})
\end{itemize}
\vspace{7cm}
...
Every \var{n1} time steps (\var{n1} is a runtime parameter, see
...
The actual time step is [either set explicitly, or] given by
\begin{equation}
  \delta t
  = \min\left( c_{\delta t}\frac{\delta x_{\rm min}}
                    {U_{\rm max}} ,
...
\hline
 ...
 8    & Linux (Kabul)     & 1.25 & $64^2\times128$
...
$ $Id: manual.tex,v 1.47 2002-07-13 16:36:21 dobler Exp $ $}
