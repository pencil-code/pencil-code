...
\item Choose one of the existing files from \file{\$PENCIL_HOME/hosts/} as
  blueprint, copy it to the file name from item
  \ref{Item-pick-config-file}. and adapt it to your system.
\end{enumerate}
...
\begin{description}
\item[Comments:] A \code{\#} sign and any text following it on the same
  line are ignored.
\item[Sections:] There are three sections:
  \begin{description}
...
test to run on a remote computer. See Sec.~\ref{S-nightly-tests} below.
