...
%%  CVS: $Id: manual.tex,v 1.168 2003-06-13 17:30:08 brandenb Exp $
%%  Description:
...
\date{$ $Date: 2003-06-13 17:30:08 $ $,~ $ $Revision: 1.168 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-06-13 17:30:08 $ $,~ $ $Revision: 1.168 $ $}
...
\begin{eqnarray}
  ...
  &\approx& \int\limits_{\tau_0}^\tau e^{-(\tau-\tau')}
              \left[ f(\tau_0) + \frac{f(\tau){-}f(\tau_0)}{\tau}\,\tau'
              \right] \; d\tau'\\
  &=&       \left[1{-}e^{-(\tau-\tau_0)}\right] f(\tau)
          - \frac{1 - e^{-(\tau-\tau_0)}(1{+}\tau)}{\tau}[f(\tau)-f(\tau_0)]
  \; ,
\end{eqnarray}
...
$ $Id: manual.tex,v 1.168 2003-06-13 17:30:08 brandenb Exp $ $}
