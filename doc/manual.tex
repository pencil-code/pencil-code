...
%%  CVS: $Id: manual.tex,v 1.252 2004-06-09 04:08:38 brandenb Exp $
%%  Description:
...
%\date{$ $Date: 2004-06-09 04:08:38 $ $,~ $ $Revision: 1.252 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2004-06-09 04:08:38 $ $,~ $ $Revision: 1.252 $ $}\\
...
% ---------------------------------------------------------------------- %
\subsection{Using non equidistant grid}
...
direction right now. The function is chosen to be\\
\begin{equation}
...
In the current implemention, without a corresponding cleaning procedure,
...
\section*{APPENDIX
  \hfill\normalsize\rm$ $Date: 2004-06-09 04:08:38 $ $,~ $ $Revision: 1.252 $ $}
...
$ $Id: manual.tex,v 1.252 2004-06-09 04:08:38 brandenb Exp $ $}
...
% LocalWords:  Kramers Myr Spitzer Kippenhahn Weigert Remeshing remeshing
% LocalWords:  phiaver
