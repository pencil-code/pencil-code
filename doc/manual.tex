...
\begin{figure}[htb]
  \centering
  \includegraphics[width=.99\textwidth,keepaspectratio]{GitHub_ci}
...
32768 & Dardel &$ $173\ps$ $&$1024^3$ & magn/noentro/CME & 32x32x32  & 24-sep-22 & AB \\
...
\begin{figure}[hbtp]
  \centering
  %\includegraphics[width=0.8\textwidth,keepaspectratio]{pdardel_strong}
...
%\includegraphics[width=.7\columnwidth]{pspec-comp}
\end{center}\caption[]{
