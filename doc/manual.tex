...
%%  CVS: $Id: manual.tex,v 1.175 2003-06-24 18:54:59 theine Exp $
%%  Description:
...
\date{$ $Date: 2003-06-24 18:54:59 $ $,~ $ $Revision: 1.175 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-06-24 18:54:59 $ $,~ $ $Revision: 1.175 $ $}
...
We treat the gas as a composition of partially ionized hydrogen and neutral
...
Summing up the individual entropies plus the entropy of mixing
$S_{\rm mix}=N_{\rm tot}k_{\rm B}\sum_ip_i\ln p_i$ we can get a closed
expression for the specific entropy $s$ in terms of $y$, $\ln\rho$ and $T$,
...
dependent on the ionization fraction $y$ such its as pressure
$P=(1\!+y+f)n_{\rm H}k_{\rm B}T$ and its internal energy
$E=\frac{3}{2}(1+y+f)n_{\rm H}k_{\rm B}T+y\chi_{\rm H}$, where $f$ gives the
ratio of neutral helium to the total amount of hydrogen.
...
\hfill{\normalsize\rm {$ $Date: 2003-06-24 18:54:59 $ $,~ $ $Revision: 1.175 $ $}}}
...
%    \begin{tabular}{rllrlrll}
  ...
  64 & mega  & 0.11 & $256^3$ &nomagn/noentro&  4x16  & 29-apr-03 & AB \\
...
=\frac{\frac{2}{3}\left(\ln\rho_{\rm H}/\rho_{\rm p}-F-T_0/T\right)-1}
      {1+y+x_{\rm He}}\ .
\]
In order to compute the pressure gradient, the derivative of $y$ with respect
...
\[
dF=\left(\frac{\partial F}{\partial\ln\rho}\right)_{s,y}\!\delta\ln\rho
   +\left(\frac{\partial F}{\partial s}\right)_{\rho,y}\!\delta s
   +\left(\frac{\partial F}{\partial y}\right)_{\rho,s}\!\delta y=0\ ,
\]
and thus
\[
\frac{\partial y}{\partial\ln\rho}
=\left(\frac{\delta y}{\delta\ln\rho}\right)_{\delta s=0}
=-\frac{(\partial F/\partial\ln\rho)_{s,y}}{(\partial F/\partial y)_{\rho,s}}
\]
and
\[
\frac{\partial y}{\partial s}
=\left(\frac{\delta y}{\delta s}\right)_{\delta\ln\rho=0}
=-\frac{(\partial F/\partial s)_{\rho,y}}{(\partial F/\partial y)_{\rho,s}}
\]
...
\begin{eqnarray}
  ...
  &\approx& \int\limits_{\tau_0}^\tau e^{-(\tau-\tau')}
              \left[ f(\tau_0) + \frac{f(\tau){-}f(\tau_0)}{\tau-\tau_0}\,\tau'
              \right] \; d\tau'\\
...
$ $Id: manual.tex,v 1.175 2003-06-24 18:54:59 theine Exp $ $}
