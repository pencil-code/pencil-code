...
%%  CVS: $Id: manual.tex,v 1.195 2003-08-15 17:21:43 mee Exp $
%%  Description:
...
\date{$ $Date: 2003-08-15 17:21:43 $ $,~ $ $Revision: 1.195 $ $}
...
\begin{titlepage}
  ...
  \emph{$ $Date: 2003-08-15 17:21:43 $ $,~ $ $Revision: 1.195 $ $}
...
\hfill{\normalsize\rm {$ $Date: 2003-08-15 17:21:43 $ $,~ $ $Revision: 1.195 $ $}}}
...
\midrule
  ...
  \var{tauheat_buffer} [$0.$]
               & time scale for heating to target temperature; zero disables
	       the buffer zone. \\
  \var{zheat_buffer} [$0.$]
               & size of the thermal buffer zone. \\
  \var{TTheat_buffer} [$0.$]
...
$ $Id: manual.tex,v 1.195 2003-08-15 17:21:43 mee Exp $ $}
