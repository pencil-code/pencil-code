...
%%  CVS: $Id: manual.tex,v 1.134 2002-10-20 18:20:46 brandenb Exp $
%%  Description:
...
the timestep. We focus on the case where $|\kv|$ is around 5, and
...
\end{equation}
For $0<\sigma<1$, the forcing function has fractional helicity;
see Sect.~4.5 of Ref.~\cite{BDS02}.
...
$ $Id: manual.tex,v 1.134 2002-10-20 18:20:46 brandenb Exp $ $}
