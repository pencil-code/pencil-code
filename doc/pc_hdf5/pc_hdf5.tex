...
Is it really a good idea ? I would think that we should converge as
fast as possible to a \emph{stable} format for this file, and thus
avoid the multiplication of a huge number of different
versions. Enforcing fixed version number should be a good way to limit
a proliferation of file versions\ldots
\emph{\quad--~rplasson}
