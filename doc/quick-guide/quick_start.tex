...
\begin{verbatim}
git clone -b master --recurse-submodules https://github.com/pencil-code/pencil-code.git 
\end{verbatim}
...
or
\begin{verbatim}
git clone -b master --recurse-submodules https://pencil-code.org/git/ pencil-code
\end{verbatim}
...
#SBATCH --cpus-per-task=7        # for multithreading
