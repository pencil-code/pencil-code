...
\begin{tabular}{|l|l|}\hline
  ...
  \verb|pencil-code/idl/read/pc_read_slice_raw.pro| & reading of any 2D slice from 3D snapshots\\\hline
  \verb|pencil-code/idl/pc_get_quantity.pro| & compute physical quantities out of raw data\\\hline
  \verb|pencil-code/idl/pc_check_quantities.pro| & dependency ckecking of physical quantities\\\hline
\end{tabular}
\end{center}
