...
\end{verbatim}
after initiallizing everything successfully, it would then start running,   
printing on the prompt the quantities specified in \file{print.in}, for 
instance,
\begin{verbatim}
...
\end{verbatim}
The file \file{COMPLETED} will appear in your run directory once the run is 
finished.
