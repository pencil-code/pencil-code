! $Id: gravity_simple.f90 13390 2010-03-03 06:48:33Z sven.bingert $
!
...
!
  namelist /grav_init_pars/ &
      ...
      ss_top, lgravx_gas, lgravy_gas, lgravz_gas, &
      xinfty, yinfty, zinfty, lxyzdependence, kappa_x1, &
      lcalc_zinfty, &
...
!
  namelist /grav_run_pars/ &
      gravx_profile, gravy_profile, gravz_profile, gravx, gravy, gravz, &
      xgrav, ygrav, zgrav, kx_gg, ky_gg, kz_gg, dgravx, pot_ratio, &
      nux_epicycle, nu_epicycle, lgravx_gas, lgravy_gas, &
      lgravz_gas, xinfty, yinfty, zinfty, &
      lcalc_zinfty, &
