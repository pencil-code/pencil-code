...
!
  ...
  ! Debug code for the g95 daily auto-test of samples/corona
  write (*,*) 'gx, gy, gz'
  write (*,*) gx, gy, gz
  write (*,*) 'dx, dy, dz'
  write (*,*) dx, dy, dz
...
!
  ...
  write (*,*) 'survived distribute_grid', iproc
  if (lroot) write (*,*) 't_sp', t_sp
!
        t_test = t_sp
        ...
        t = t_sp
  write (*,*) 'survived time broadcast', iproc
      endif
!
