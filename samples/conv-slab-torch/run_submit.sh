...
#apptainer exec --nv -B $PENCIL_HOME:$PENCIL_HOME -B scripts:/opt/scripts -B /scratch/project_2000403/sgiridha/data:$PWD/data -B /scratch/project_2000403/sgiridha/data:/data torchfort_bisonflex.sif bash rm -rf data
