...
apptainer exec --nv -B $PENCIL_HOME:$PENCIL_HOME -B /appl:/appl -B scripts:/opt/scripts -B /users/$USER/tmpdir:/opt/tmpdir torchfort_bisonflex.sif bash /opt/scripts/compile.sh
