...
def get_dstgrid(
    ...
    if not ncpus == [1, 1, 1]:
        ...
        sets["nprocy"][()] = ncpus[1]
        sets["nprocz"][()] = ncpus[2]
    #elif exists(join(dst, "src", "cparam.local")):
    #    from pencil.sim import get_cparam
    #    cpars=get_cparam(join(dst, "src", "cparam.local"))
    #    print(cpars)
    #    sets["nprocx"][()] = cpars["nprocx"]
    #    sets["nprocy"][()] = cpars["nprocy"]
    #    sets["nprocz"][()] = cpars["nprocz"]
