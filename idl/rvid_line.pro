pro rvid_line,field,mpeg=mpeg,png=png,tmin=tmin,tmax=tmax,max=amax,min=amin,$
  ...
  transp=transp,global_scaling=global_scaling
;
; $Id: rvid_line.pro,v 1.10 2005-12-20 19:25:37 mee Exp $
;
  ...
  if t ge tmin and t le tmax then begin
    if ijump eq njump then begin
      if not keyword_set(noplot) then begin
        if keyword_set(exp) then plot,zaxisscale,exp(axz),ps=-2,yr=[amin,amax] else plot,zaxisscale,axz,ps=-2,yr=[amin,amax]
      endif
