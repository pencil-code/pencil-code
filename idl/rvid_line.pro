...
;
; $Id: rvid_line.pro,v 1.4 2004-04-23 06:45:52 brandenb Exp $
;
...
if keyword_set(proc) then begin
  file_slice=datadir+'/'+proc+'/slice_'+field+'.xz'
endif else begin
...
if keyword_set(mesh) then begin
  ...
  pc_read_grid,z=zaxisscale
  zaxisscale=zaxisscale[nghostz-1:nghostz+nz]
endelse
;
