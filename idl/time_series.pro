;  $Id: time_series.pro,v 1.14 2003-08-15 18:38:22 brandenb Exp $
;
...
if defined(i_2aybym) ne 0 then aybym=reform(a(i_2aybym-1,*))
if defined(i_2exaym) ne 0 then exaym=reform(a(i_2exaym-1,*))
