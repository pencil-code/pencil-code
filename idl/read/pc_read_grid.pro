...
;
  if (file_test (datadir+'/grid.h5')) then begin
    ; HDF5
    t = 0.0d0
    x = pc_read ('grid/x', file=datadir+'/grid.h5')
    y = pc_read ('grid/y')
    z = pc_read ('grid/z')
    dx = pc_read ('grid/dx')
    dy = pc_read ('grid/dy')
    ...
    Ly = pc_read ('grid/Ly')
    Lz = pc_read ('grid/Lz')
    dx_1 = pc_read ('grid/dx_1')
    dy_1 = pc_read ('grid/dy_1')
    dz_1 = pc_read ('grid/dz_1')
    dx_tilde = pc_read ('grid/dx_tilde')
    dy_tilde = pc_read ('grid/dy_tilde')
    dz_tilde = pc_read ('grid/dz_tilde')
    found_Lxyz=1
    found_grid_der=1
