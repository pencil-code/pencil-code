pro rvid_box,field,mpeg=mpeg,png=png,PNG_TRUECOLOR=png_truecolor,tmin=tmin,$
  ...
  newwindow=newwindow
;
; $Id: rvid_box.pro,v 1.44 2006-11-15 17:28:00 dobler Exp $
;
...
if (n_elements(proc) le 0) then begin
  ...
  if (dim.nprocx*dim.nprocy*dim.nprocy eq 1) then datadir=datatopdir+'/proc0'
endif else begin
