pro rvid_box,field,mpeg=mpeg,png=png,TRUEPNG=png_truecolor,tmin=tmin,$
  ...
  newwindow=newwindow
;
; $Id: rvid_box.pro,v 1.50 2007-08-03 14:00:59 ajohan Exp $
;
...
;
;  Preset mathematical operation on data (if requested).
;
...
;
;  Preset mathematical operation on data before plotting.
;
  if (keyword_set(sqroot)) then begin      
    xy2=sqrt(xy2)
    xy= sqrt(xy)
