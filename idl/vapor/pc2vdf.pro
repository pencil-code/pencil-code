...
readpath='/Users/guerrero/pencil-code/gustavo/shear/A32kf2a'
writepath='/Users/guerrero/Vapor'
...
cd, readpath 
     ...
     pc_read_var,variables=['aa'],varfile=varfile1,obj=test,/quiet
...
;
varnames = ['rho','vx','vy','vz','bx','by','bz','lnE']
...
itt=it+tinit
 varfile = 'VAR'+strtrim(itt*fac,2)
  ...
  cd, readpath
     ...
     pc_read_var,variables=['uu','aa','lnrho'],varfile=varfile,obj=test,/quiet   
    ...
    lnE=(alog(dot2(bb)))[l1:l2,m1:m2,n1:n2]
cd, writepath
