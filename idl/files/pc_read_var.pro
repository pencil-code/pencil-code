...
pro pc_read_var,t=t,x=x,y=y,z=z,dx=dx,dy=dy,dz=dz,deltay=deltay, all=all, $
                ...
                datadir=datadir,proc=proc,PRINT=PRINT,QUIET=QUIET,HELP=HELP,ALL_PROCS=ALL_PROCS
...
; If no meaningful parameters are given show some help!
  IF ( keyword_set(HELP) ) THEN BEGIN
    ...
    print, "             /PRINT, /QUIET, /HELP, /ALL_PROCS                                                         "
    print, "                                                                                           "
    ...
    print, ""
    print, "/ALL_PROCS: Read the data from ALL the processors.                                          "
    print, ""
