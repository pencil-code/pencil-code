...
; $Id$
;+
;  Reads and displays snapshots at specified times.
;
;  Typical calling sequence:
;    times=[0,0.1,0.2,0.3]
;    rvid_plane_multiplot,'uz',times,min=-1e-1,max=1e-1,/proc
;
;-
pro rvid_plane_multiplot,field,times,max=amax,quiet=quiet, $
    min=amin,extension=extension,datadir=datadir,oldfile=oldfile,debug=debug, $
...
if (file_test (datadir+'/slices', /directory)) then begin
   print,"This routine has not yet been adapted to hdf5!"
   stop
...
contour,plane2,y2,x2,nlev=50,/fill
